...
//			               int cancelPolicy) throws FMPMcuException, Exception;
	...
	public Hashtable cmdReqImagePropagate(String mcuId, int upgradeType, int control,
			String imageKey, String imageUrl, String upgradeCheckSum, 
			String imageVersion, String targetModel , int cloneCount, String add3Day, List<String> filterValue) 
					throws FMPMcuException, Exception;
...
//    public Map<String, String> getModemEventLog(String mdsId, int logCount) throws Exception;
     ...
     * @throws FMPMcuException, Exception
     */
    public String cmdForceUpload(String mcuId, String serverName, int dataCount, String fromDate, String toDate)
        throws FMPMcuException, Exception; 
	...
	MeterData cmdGetMeteringDataToNeighborDCU(String mcuId, String meterId,
			String modemId, String nOption, String fromDate, String toDate,
			String[] modemArray) throws FMPMcuException, Exception;
...
// 			throws FMPMcuException, Exception;
     ...
     * @throws FMPMcuException, Exception
     */
	public List<ScheduleData> cmdMcuGroupGetSchedule(Integer groupId) 
			throws FMPMcuException, Exception;
     ...
     *
     * @param groupId GROUP ID
     * @param String[][] Schedule List
     * @return Result List
     * @throws FMPMcuException, Exception
     */
	public List<McuScheduleResult> cmdMcuGroupSetSchedule(Integer groupId, String[][] args) 
			throws FMPMcuException, Exception;
	
	/**
     * MCU Group Set Schedule -> return값이 출력되는 Set Schedule
     *
     * @param mcuId Mcu ID
     * @param String[][] Schedule List
     * @return String
     * @throws FMPMcuException, Exception
     */
	public String cmdMcuGroupSetSchedule_(String mcuId, String[][] args) 
			throws FMPMcuException, Exception;

	/**
	 * MCU Group Set Property 
	 *
	 * @param groupId Group ID
	 * @param String[] Key
	 ...
	 * @throws FMPMcuException, Exception
	 */
	public List<McuPropertyResult> cmdMcuGroupSetProperty(Integer groupId, String[] key, String[] keyValue) 
			throws FMPMcuException, Exception;
	 ...
	 * @throws FMPMcuException, Exception
	 */
	public Map<String, Object> cmdMeteringDataRequest(String mcuId, String[] modemIds, String fromDate, String toDate) 
			throws FMPMcuException, Exception;

	/**
	 * Get Coordinator broadcast configuration 
	 * SP-766
     * @param mcuId Mcu ID
	 * @return 
	 * @throws FMPMcuException, Exception
	 */	
	public Hashtable cmdGetCoordinatorConfigure(String mcuId)
			throws FMPMcuException, Exception;
		
	/**
	 * Set Coordinator broadcast configuration 
	 * SP-766
     * @param mcuId Mcu ID
     * @param configurations
     * @param modemMode
     * @param resetTime
     * @param metringInterval
     * @param transmitFrequency
     * @param cloneTerminate
	 * @return 
	 * @throws FMPMcuException, Exception
	 */	
     ...
     * @throws FMPMcuException, Exception
     */
    public List<sensorPathEntry> cmdGetSensorPath(String mcuId, String parserName)
        throws FMPMcuException, Exception;
}
