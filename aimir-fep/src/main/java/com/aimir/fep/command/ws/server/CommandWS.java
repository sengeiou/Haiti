...
public class CommandWS
{
            ...
            @WebParam(name="MeterId") String meterId) throws Exception
    {
        ...
        log.info(saver.getClass().getName());
        ResponseMap map = new ResponseMap();
        Map<String, String> response = new HashMap<String, String>();
    ...
    public meterEntry[] cmdGetMeterList(
    		...
    		throws Exception{
        try {
        	meterEntry[] entry = command.cmdGetMeterList(mcuId, nOption, value);
            return entry;
        }
        catch (Exception e) {
            throw e;
    ...
    public String coapPing(
        ...
        return command.coapPing(ipAddress, device, type, protocol, fwVersion);
    }
    ...
    public ResponseMap coapGetInfo(
    	...
    	ResponseMap response = new ResponseMap();
    	response.setResponse(command.coapGetInfo(ipv4,ipv6,type,protocol,fwVersion));
    	return response;
    }
    ...
    public ResponseMap modemReset(
    	...
    	ResponseMap response = new ResponseMap();
    	response.setResponse(command.modemReset(ipv4,ipv6,type,protocol,fwVersion));
        return response;
    }
    ...
    public ResponseMap coapBrowser(
    	...
    	ResponseMap response = new ResponseMap();
    	response.setResponse(command.coapBrowser(ipv4,ipv6,uri,query,config,type,protocol,fwVersion));
        return response;
    }
...
//        response.setResponse(command.getModemEventLog(mdsId,logCount));
    ...
    @WebMethod
	public ResponseMap setCloneOnOff(@WebParam(name = "ModemId") String modemId, @WebParam(name = "CloneCode") String cloneCode, @WebParam(name = "Count") Integer count) throws Exception {
		log.info("modemId[" + modemId + "] count [" + count + "]");

		ResponseMap response = new ResponseMap();
//		response.setResponse(command.getModemEventLog(modemId, count));
		response.setResponse(command.setCloneOnOff(modemId, cloneCode, count));
		return response;
	}
	...
	public ResponseMap setCloneOnOffWithTarget(@WebParam(name = "ModemId") String modemId, 
			...
			@WebParam(name = "EuiCount") Integer euiCount,
     ...
     */
    @WebMethod
    public ResponseMap cmdSORIASetMeterSerial(
    		@WebParam(name="Eui") String eui) throws Exception
    {
    	ResponseMap response = new ResponseMap();
    	response.setResponse(command.cmdSORIASetMeterSerial(eui));
    	return response;
    }
...
//        response.setResponse(command.cmdMultiFirmwareOTA(OTATargetType.valueOf(otaTargetType), deviceList, take_over, useNullBypass, firmwareId));
     ...
     */
    @WebMethod
    public ResponseMap cmdMultiFirmwareOTAImprov(
    		@WebParam(name="OTATargetType") String otaTargetType,    		
    		@WebParam(name="FirmwareId") String firmwareId,
    		@WebParam(name="IssueDate") String issueDate,
    		@WebParam(name="OTAExecuteType") int otaExecuteType,
    		@WebParam(name="UseAsyncChannel") boolean useAsyncChannel
    		) throws Exception
    {
        ResponseMap response = new ResponseMap();
        response.setResponse(command.cmdMultiFirmwareOTAImprov(
        		OTATargetType.valueOf(otaTargetType), 
        		firmwareId,
        		issueDate,
        		OTAExecuteType.getItem(otaExecuteType),
        		useAsyncChannel));
        return response;
    }    
    
    @WebMethod
    public String cmdExecutorManagerInfo(
    		@WebParam(name="callName") String callName) throws Exception
    {
        return command.cmdExecutorManagerInfo(callName);
    }
    ...
    public ResponseMap cmdReqImagePropagate(
		...
		@WebParam(name = "CloneCount") int cloneCount,
		@WebParam(name = "Add3Day") String add3Day,		
        @WebParam(name = "FilterValue") java.util.List<java.lang.String> filterValue
    ) throws Exception
    {
        ResponseMap response = new ResponseMap();
     ...
     */
    @WebMethod
    public String cmdForceUpload(@WebParam(name="McuId") String mcuId,
            @WebParam(name="serverName") String serverName,
            @WebParam(name="dataCount") int dataCount,
            @WebParam(name="fromDate") String fromDate,
            @WebParam(name="toDate") String toDate)
                    throws Exception
    {
        return command.cmdForceUpload(mcuId, serverName, dataCount, fromDate, toDate);
    }
    /**
     * MCU Get Schedule
     *
    ...
    public MeterData cmdGetMeteringDataToNeighborDCU(@WebParam(name="McuId") String mcuId,
            @WebParam(name="MeterSerialNo") String meterId,
            @WebParam(name="ModemId") String modemId,
            @WebParam(name="nOption") String nOption,
            @WebParam(name="FromDate") String fromDate, 
                    ...
                    throws Exception
    {
        log.info("mcuId[" + mcuId + "] meterId[" + meterId+"] modemId[" + modemId+"] nOption[" + nOption + "] fromDate[" + fromDate + "] toDate[" + toDate +"]");
        try {
            MeterData md = command.cmdGetMeteringDataToNeighborDCU(mcuId, meterId, modemId, nOption, fromDate, toDate, modemArray);
            return md;
        }
        catch (Exception e) {
            throw e;
...
//            MeterData md = command.cmdDmdNiGetRomRead(mcuId, meterId, modemId, fromDate, toDate);
    ...
    // INSERT START SP-575
    public ResponseMap cmdGeneralNiCommand(
    		@WebParam(name="ModemId") String modemId, 
    		@WebParam(name="RequestType") String requestType, 
    		@WebParam(name="AttributeId") String attributeId,
    		@WebParam(name="AttributeParam") String attributeParam
    ...
    + attributeId + "] attributeParam[" + attributeParam  +"]"  );
        ResponseMap response = new ResponseMap();
        response.setResponse(command.cmdGeneralNiCommand(modemId,requestType,attributeId,attributeParam));
        return response;
    }    
    // INSERT END SP-575    
    ...
    public List<ScheduleData> cmdMcuGroupGetSchedule(@WebParam(name="GroupId") Integer groupId)
        throws Exception
    {
    	List<ScheduleData> response = new ArrayList<ScheduleData>();
    	response = command.cmdMcuGroupGetSchedule(groupId);
    ...
    /**
     * MCU Group Set Schedule
     *
     * @param groupId Group ID
     * @param args Schedule List
     * @return Result List
     * @throws Exception
     */
    @WebMethod(operationName="cmdMcuGroupSetSchedule")
    public List<McuScheduleResult> cmdMcuGroupSetSchedule(@WebParam(name="GroupId") Integer groupId,
    		@WebParam(name="ScheduleList") String[][] args )
        throws Exception
    {
    	List<McuScheduleResult> response = new ArrayList<McuScheduleResult>();
    	response = command.cmdMcuGroupSetSchedule(groupId, args);
    ...
    public List<McuPropertyResult> cmdMcuGroupSetProperty(@WebParam(name="GroupId") Integer groupId,
    		@WebParam(name="Key") String[] key,
   			@WebParam(name="KeyValue") String[] keyValue) 
    	throws Exception
    {
    	List<McuPropertyResult> response = new ArrayList<McuPropertyResult>();
    	response = command.cmdMcuGroupSetProperty(groupId, key, keyValue);
    ...
    public ResponseMap cmdMeteringDataRequest(
            @WebParam(name="McuId") String mcuId, 
            @WebParam(name="ModemIdList") String[] modemIds,
            @WebParam(name="FromDate") String fromDate, 
            @WebParam(name="ToDate") String toDate)
                    throws Exception
    {
        ...
        try {
        	ResponseMap response = new ResponseMap();
        	response.setResponse(command.cmdMeteringDataRequest(mcuId, modemIds, fromDate, toDate));
        	return response;
        }
        catch (Exception e) {
            throw e;
    ...
    public ResponseMap cmdGetCoordinatorConfigure(
		@WebParam(name = "McuId") String mcuId
    ) throws Exception
    {
        ResponseMap response = new ResponseMap();
        
        response.setResponse(command.cmdGetCoordinatorConfigure(
        		mcuId));
    ...
    public ResponseMap cmdSetCoordinatorConfigure(
		@WebParam(name = "McuId") String mcuId,    		
        @WebParam(name = "Configurations") int configurations,
        @WebParam(name = "ModemMode") int modemMode,
		@WebParam(name = "ResetTime") int resetTime,    		
		@WebParam(name = "MeteringInterval") int meteringInterval,    		
		@WebParam(name = "TransmitFrequency") int transmitFrequency,    		
		@WebParam(name = "CloneTerminate") int cloneTerminate
    ) throws Exception
    {
        ResponseMap response = new ResponseMap();
        
        response.setResponse(command.cmdSetCoordinatorConfigure(
        	    mcuId,
        	    configurations,
        	    modemMode,
        	    resetTime,
    ...
    @WebMethod
    public ResponseMap cmdCloneOnOffViaSchedule(
    		@WebParam(name="OtaTargetType") String otaTargetType,   
    		@WebParam(name="OTAExecuteType") int otaExecuteType,    		
    		@WebParam(name="IssueDate") String issueDate,
    		@WebParam(name="Propagation") boolean propagation,
    		@WebParam(name="ModemCommandType") String modemCommandType,
    		@WebParam(name="CloningTime") int cloningTime
    		) throws Exception
    {
        ResponseMap response = new ResponseMap();
        response.setResponse(command.cmdCloneOnOffViaSchedule(
        		OTATargetType.getItem(otaTargetType),
        		OTAExecuteType.getItem(otaExecuteType), 
        		issueDate,
        		propagation,
        		ModemCommandType.getItem(modemCommandType),
        		cloningTime));
        return response;
    } 
     ...
     * @param targetModem	대상모뎀, MMIU 객체
     ...
     */
    @WebMethod
    public ResponseMap cmdFOTA(
    		@WebParam(name="TargetModem") MMIU targetModem,
    		@WebParam(name="FtpUrl") String ftpUrl,
    		@WebParam(name="FtpPort") String ftpPort,
    		@WebParam(name="FtpDirectory") String ftpDirectory,
    		@WebParam(name="TargetFile") String targetFile,
