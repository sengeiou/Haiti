...
public class CommandBO implements CommandBOMBean, MBeanRegistration
{
    ...
    throws Exception
    {
        ...
        try {
            ...
            return KamstrupCIDMeta.getResult(gw.cmdKamstrupCID(mcuId, meterId, req), meter.getModel().getName());
        }
        finally {
            gw.close();
        }
    ...
    throws Exception
    {
        ...
        try {
            Meter meter = meterDao.get(meterId);
            return KamstrupCIDMeta.getResult(gw.cmdKamstrupCID(mcuId, meterId, kind, req), meter.getModel().getName());
        }
        finally {
            gw.close();
        }
