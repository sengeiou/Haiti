...
/**
 * Event ID : EV_PH_240.2.0 (Modem Tamper Alarm)
 * 
 ...
 */
@Component
public class EV_PH_240_2_0_Action implements EV_Action {
	private static Log log = LogFactory.getLog(EV_PH_240_2_0_Action.class);
	...
	public void execute(FMPTrap trap, EventAlertLog event) throws Exception {
		...
		log.debug("EV_PH_240_2_0_Action : EventName[modemTamper] " + " EventCode[" + trap.getCode() + "] MCU[" + trap.getMcuId() + "] TargetClass[" + event.getActivatorType() + "] openTime[" + openTime + "]");
		...
		try {
			...
			log.debug("EV_PH_240_2_0_Action : event[" + event.toString() + "]");
