...
/**
 * Event ID : 200.57.0 evtShutDown
 *
 * @author Elevas Park
 * @version $Rev: 1 $, $Date: 2016-09-18 15:59:15 +0900 $,
 */
@Service
public class EV_PH_200_57_0_Action implements EV_Action
{
    private static Log log = LogFactory.getLog(EV_PH_200_57_0_Action.class);
    ...
    public void execute(FMPTrap trap, EventAlertLog event) throws Exception
    {
        ...
        log.debug("DCU Shtudown Event Action Compelte");
    }
}
