...
/**
 * Event ID : EV_PH_200_52_0 Processing Class
 *
 * @author Tatsumi
 * @version $Rev: 1 $, $Date: 2016-05-17 15:59:15 +0900 $,
 */
@Component
public class EV_PH_200_52_0_Action implements EV_Action
{
    private static Log log = LogFactory.getLog(EV_PH_200_52_0_Action.class);
    ...
    {
        log.debug("EV_PH_200_52_0_Action : EventCode[" + trap.getCode()
                +"] MCU["+trap.getMcuId()+"]");
        ...
        try {
            ...
            log.debug("EV_PH_200_52_0_Action : mcuId[" + mcuId + "]");
