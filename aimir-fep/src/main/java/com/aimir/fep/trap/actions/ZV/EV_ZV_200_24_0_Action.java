...
@Component
public class EV_ZV_200_24_0_Action implements EV_Action
{
	...
	public void execute(FMPTrap trap, EventAlertLog event) throws Exception {
		log.debug("EventName[eventPowerRestore] "+" EventCode[" + trap.getCode()+"] Modem["+trap.getSourceId()+"]");
...
//        	LocationDao locationDao = DataUtil.getBean(LocationDao.class);
            ...
            if (existMcu == null) {
                ...
                event.getEventAlert().setName("DCU Power Restore");
