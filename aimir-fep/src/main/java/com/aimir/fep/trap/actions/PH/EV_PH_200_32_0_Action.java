...
/**
 * Event ID : EV_PH_200.32.0 (Security Alarm)
 *
 * @author tatsumi
 * @version $Rev: 1 $, $Date: 2016-05-13 10:00:00 +0900 $,
 */
@Component
public class EV_PH_200_32_0_Action implements EV_Action
{
    private static Log log = LogFactory.getLog(EV_PH_200_32_0_Action.class);
    ...
    {
        log.debug("EV_PH_200_32_0_Action : EventName[evtSecurity] "
        ...
        try { 
            ...
            log.debug("EV_PH_200_32_0_Action : event[" + event.toString() + "]");
