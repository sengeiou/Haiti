 ...
 */
@Service
public class EV_PH_200_1_0_Action implements EV_Action
{
    private static Log log = LogFactory.getLog(EV_PH_200_1_0_Action.class);
    ...
    public void execute(FMPTrap trap, EventAlertLog event) throws Exception
    {
        ...
        String publicIpV6 = event.getEventAttrValue("stringEntry.1");
        
        String privateIpV4 = event.getEventAttrValue("stringEntry.2");
        String privateIpV6 = event.getEventAttrValue("stringEntry.3");
        ...
        try {
            ...
            if (existMcu == null) {
                ...
                */
                ...
                if (model != null) {
                	...
                	throw new Exception("Unknown DCU Model - " + sysModel);
                }
			...
			log.error("DCU Install event error - " + e.getMessage(), e);
			if (txStatus != null) {
