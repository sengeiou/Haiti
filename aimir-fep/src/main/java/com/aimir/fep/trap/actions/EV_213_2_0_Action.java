...
/**
 * Event ID : 203.2.0 Processing Class
 *
 * @author Y.K.Park
...
public class EV_213_2_0_Action implements EV_Action
{
    private static Log log = LogFactory.getLog(EV_213_2_0_Action.class);
    ...
    {
        log.debug("EV_213_2_0_Action : EventName[eventVoltageAlarm] "
        ...
        try { 
            ...
            log.debug("EV_213_2_0_Action : byteEntry[" + errCode + "]");

        }catch(Exception ex) { log.error(ex,ex); }

        // Log
        log.debug("EV_213_2_0_Action : modemId[" + modemId + "]"
                +" nReason["+errCode+"] ");
        ...
        log.debug("eventVoltageAlarm Event Action Compelte");
    }
}
