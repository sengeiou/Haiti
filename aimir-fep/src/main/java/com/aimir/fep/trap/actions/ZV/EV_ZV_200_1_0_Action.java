...
/**
 * Event ID : ZV_200.1.0 (DCU Install) <br>
 * Vietnam EVN Zigbee DCU
 *
 * @author goodjob
 * @version $Rev: 1 $, $Date: 2015-07-08 10:00:00 +0900 $,
 */
@Component
public class EV_ZV_200_1_0_Action implements EV_Action {
	private static Log log = LogFactory.getLog(EV_ZV_200_1_0_Action.class);
	...
	public void execute(FMPTrap trap, EventAlertLog event) throws Exception {
		...
		try {
			...
			if (existMcu == null) {
				...
				dcuDao.add(mcu);
				EventUtil.sendEvent("Equipment Registration", TargetClass.DCU, mcu.getSysID(), trap.getTimeStamp(), new String[][] {}, event);
			} else {
