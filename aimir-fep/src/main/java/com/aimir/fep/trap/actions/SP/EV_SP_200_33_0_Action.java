 ...
 */
@Component
public class EV_SP_200_33_0_Action implements EV_Action
{
    private static Log log = LogFactory.getLog(EV_SP_200_33_0_Action.class);
    ...
    {
        log.debug("EV_SP_200_33_0_Action : EventCode["+trap.getCode()+"] MCU["+trap.getMcuId()+"]");
