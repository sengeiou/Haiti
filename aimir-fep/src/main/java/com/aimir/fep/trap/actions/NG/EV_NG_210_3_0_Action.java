...
/**
 * Event ID : NG_210.3.0 (PLC Modem SNR)
 * <br>PLC-G3 Modem
 *
 * @author goodjob
 ...
 */
@Component
public class EV_NG_210_3_0_Action implements EV_Action
{
    private static Log log = LogFactory.getLog(EV_NG_210_3_0_Action.class);
    ...
    public void execute(FMPTrap trap, EventAlertLog event) throws Exception
    {
        ...
        try{
            ...
            snrLog.setDeviceType(ModemType.PLC_G3.name());
