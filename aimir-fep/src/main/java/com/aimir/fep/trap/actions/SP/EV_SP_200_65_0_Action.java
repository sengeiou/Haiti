...
public class EV_SP_200_65_0_Action implements EV_Action {
	...
	public void execute(FMPTrap trap, EventAlertLog event) throws Exception {
		...
		try {
			...
			logger.debug("[EV_SP_200_65_0_Action] upgradeType={}, TargetClass={}", OTA_UPGRADE_TYPE.getItem(upgradeType), OTA_UPGRADE_TYPE.getItem(upgradeType).getTargetClass().name());
			...
			logger.debug("[EV_SP_200_65_0_Action] targetModel={}", targetModel);
	...
	public void makeEvent(TargetClass activatorType, String activatorId, TargetClass targetType, String openTime, String elapseTime, OTA_UPGRADE_RESULT_CODE resultCode, String message, String operatorType, Location location) {
		logger.debug("[EV_SP_200_65_0_Action][activatorId={}][evtOTADownloadEnd] MakeEvent.", activatorId);
		...
		try {
			...
			logger.debug("[EV_SP_200_65_0_Action][activatorId={}][openTime={}] evtOTADownloadEnd - {}", activatorId, openTime, resultValue);
		} catch (Exception e) {
