 ...
 */
@Service
public class EV_PH_200_17_0_Action implements EV_Action
{
    private static Log log = LogFactory.getLog(EV_PH_200_17_0_Action.class);
    ...
    {
        log.debug("EV_PH_200_17_0_Action : EventCode[" + trap.getCode()
        +"] MCU["+trap.getMcuId()+"]");
