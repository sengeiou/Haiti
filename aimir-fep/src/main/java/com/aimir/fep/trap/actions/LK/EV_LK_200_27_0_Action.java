...
/*
 * 200.27	evtBatteryOut	OID	3	True	Major		DCU Battery out detect
     1.5	batteryADC	WORD	2				Battery ADC value

 */
@Component
public class EV_LK_200_27_0_Action implements EV_Action{
	private static Log log = LogFactory.getLog(EV_LK_200_27_0_Action.class);
	...
	public void execute(FMPTrap trap, EventAlertLog event) throws Exception {
		...
		log.debug("EventName[evtBatteryOut] " + " EventCode[" + trap.getCode() + "] DCU[" + trap.getMcuId() + "]");
		...
		try {
			...
			event.getEventAlert().setName("DCU Battery Out detect");
		...
		log.debug("DCU Battery Out Action Compelte");
	}
}
