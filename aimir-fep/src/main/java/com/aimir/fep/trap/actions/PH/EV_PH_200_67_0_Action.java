...
/**
 * Event ID : EV_PH_200.67.0 (Communication Fail Alarm Event)
 *
 * @author 
 * @version $Rev: 1 $, $Date: 2016-05-27 10:00:00 +0900 $,
 */
@Component
public class EV_PH_200_67_0_Action implements EV_Action
{
    private static Log log = LogFactory.getLog(EV_PH_200_67_0_Action.class);
    @Autowired
    MCUDao mcuDao;
   ...
   /**
    ...
    {
        log.debug("EV_PH_200_67_0_Action : EventName[evtCommFail] "
