...
/**
 * Encodes Circuit Service.
 * 
 * @author D.J Park (dong7603@nuritelecom.com)
 * @version $Rev: 1 $, $Date: 2006-10-16 15:59:15 +0900 $,
 */
public class CircuitEncoder implements ProtocolEncoder
{
    private Log log = LogFactory.getLog(CircuitEncoder.class);
     ...
     * @throws ProtocolEncoderException  indicating that is was error of Encode
     */
