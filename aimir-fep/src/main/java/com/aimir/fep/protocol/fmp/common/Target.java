 ...
 *         &lt;element name="mcuSwRevision" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="mcuSwVersion" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
public class Target
{
    ...
    protected int port = Integer.parseInt(FMPProperty.getProperty(
                "protocol.mcu.listenport","8000"));
    protected String version = FMPProperty.getProperty(
            "protocol.version","0100");
    protected int timeout = Integer.parseInt(
            FMPProperty.getProperty("protocol.response.timeout","15"));
    protected int retry = Integer.parseInt(FMPProperty.getProperty(
                "protocol.retry","3"));
