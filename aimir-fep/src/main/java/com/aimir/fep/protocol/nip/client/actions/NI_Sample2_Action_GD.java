 ...
 *
 */
public class NI_Sample2_Action_GD extends NICommandAction {
	private static Logger logger = LoggerFactory.getLogger(NI_Sample2_Action_GD.class);
	private String actionTitle = "NI_Sample2_Action_GD";

	public NI_Sample2_Action_GD() {
