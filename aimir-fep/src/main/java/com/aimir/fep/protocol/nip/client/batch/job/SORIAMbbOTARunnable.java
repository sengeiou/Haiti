 ...
 */
@Deprecated
public class SORIAMbbOTARunnable implements IBatchRunnable {
	private static Logger logger = LoggerFactory.getLogger(SORIAMbbOTARunnable.class);
	...
	public SORIAMbbOTARunnable(CommandGW gw, OTATargetType otaTargetType, Target target, Map<String, Object> params, boolean useAsyncChannel) {
		logger.debug("# SORIAMbbOTARunnable. TargetType={}, targetInfo={}, params={}, useAsyncChannel={}", otaTargetType, target.toString(), params.toString(), useAsyncChannel);
	...
	@Override
	public void run() {
		logger.debug("# SORIAMbbOTARunnable Start.");
		logger.debug("Excute [START] OTATargetType={}, newFwVersion={}, ExecuteType={}, Target={}", otaTargetType, newFwVersion, (useAsyncChannel == true ? "AsyncChannel" : "SMS"), target);
		...
		logger.debug("# SORIAMbbOTARunnable End.");
	}
