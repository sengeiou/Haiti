...
public class SnmpTrapDecoder extends CumulativeProtocolDecoder {
    ...
    private static Log logger = LogFactory.getLog(SnmpTrapDecoder.class);
    ...
    protected boolean doDecode(IoSession ioSession, IoBuffer ioBuffer, ProtocolDecoderOutput protocolDecoderOutput) throws Exception {
        logger.info("@@ Received ["+ioSession.getRemoteAddress()+" SessionId = "+ioSession.getId()+"] : LIMIT["+ioBuffer.limit()+"] POSITION["+ioBuffer.position()+"] CAPACITY["+ioBuffer.capacity()+"]");
