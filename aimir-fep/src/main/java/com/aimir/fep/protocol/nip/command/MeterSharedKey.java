...
//        meterSharedKey = DataUtil.getString(b);
    	...
    	masterKeyHex = Hex.decode(b);
    	pos += b.length;
    	System.arraycopy(bx, pos, b, 0, b.length);
    	unicastKey = DataUtil.getString(b);
    	unicastKeyHex = Hex.decode(b);
    	
    	pos += b.length;
    	System.arraycopy(bx, pos, b, 0, b.length);
    	multicastKey = DataUtil.getString(b);
    	multicastKeyHex = Hex.decode(b);
    	
    	pos += b.length;
    	System.arraycopy(bx, pos, b, 0, b.length);
    	authenticationKey = DataUtil.getString(b); 	
    	authenticationKeyHex = Hex.decode(b);
    }
...
//        return "Master_key: "+masterKey+", "+
//                "\nHLS-Secret-Unique: "+unicastKey+", "+
//                "\nGlobal_encryption_unicast_key: "+multicastKey+", "+
//                "\nAuthentication_key: "+authenticationKey;
        return "Master_key: "+masterKeyHex+", "+
        "\nHLS-Secret-Unique: "+unicastKeyHex+", "+
        "\nGlobal_encryption_unicast_key: "+multicastKeyHex+", "+
        "\nAuthentication_key: "+authenticationKeyHex;
    }
