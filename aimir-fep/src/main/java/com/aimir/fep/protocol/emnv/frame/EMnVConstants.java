...
//	}
	...
	public enum EMnVMeteringDataSatus {
		NOMAL((byte) 0x00, "모뎀정상", 1), METERING_FAIL((byte) 0x01, "검침실패", 1), BLACK_OUT((byte) 0x02, "정전발생", 1);
	...
	public enum EMnVModebusVendorType{
		LS((byte)0x00, "LS 산전"), HYUNDAI((byte)0x01, "현대중공업"), ROCKWELL((byte)0x02, "로크웰"), DEFAULT((byte)0x09, "표준");
