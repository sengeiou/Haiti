                ...
                case  Command:
                    ...
                    switch (command.niAttributeId) {
                        ...
                        case NodeAuthorization:
                            ...
                            break;                            
                        case ModemResetTimeRandomFactor: 
                        	command.abstractCmd = new ModemResetTimeRandomFactor();
                            switch (command._commandType) {
                            case  Get:
                                command.payload = command.abstractCmd.get(param);
                                break;
                        ...
                        case InitiateModuleUpgrade:
                        	command.abstractCmd = new InitiateModuleUpgrade();
                        	switch (command._commandType) {
                        	case Set:
                        		command.payload = command.abstractCmd.set(param);
                        		break;
	    ...
	    try {
	        switch (command.niAttributeId) {
	            ...
	            case MBBModuleInformation:
	            	command.abstractCmd = new MBBModuleInformation();
            		break;
	            case InitiateModuleUpgrade:
	            	command.abstractCmd = new InitiateModuleUpgrade();
            		break;
