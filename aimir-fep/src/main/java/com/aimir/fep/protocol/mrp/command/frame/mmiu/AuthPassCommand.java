/**
 * @(#)AuthPassCommand.java       1.0 03/09/01 *
...
public class AuthPassCommand extends CommandMMIU {

    private Log log = LogFactory.getLog(getClass());
    public static final byte CMD_AUTH_PASS     = 0x00;
    public static final char CMD_USERAUTH_PASS = 0x90;
     ...
     * @param data
     */
    public AuthPassCommand(byte cmd,byte[] sessionkey,String scuid) {
         super(cmd, scuid);
     ...
     * @param  command
     */
    public AuthPassCommand(char cmmd) {
        this.cmmd = cmmd;
    }
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Command c
                = new AuthPassCommand(AuthPassCommand.CMD_AUTH_PASS,sessionkey.getBytes(),
                                      "01192951370");
