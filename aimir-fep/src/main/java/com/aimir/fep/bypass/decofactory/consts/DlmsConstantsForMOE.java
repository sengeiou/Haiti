...
public class DlmsConstantsForMOE {
	...
	public enum DemandPeriodAttributes {
		CLASS_ID("0005"), OBIS_DEMAND_PLUS_A_PERIOD("0100010400FF"), OBIS_DEMAND_PLUS_A_NUMBER("0100010400FF"), OBIS_DEMAND_MINUS_A_PERIOD("0100020400FF"), OBIS_DEMAND_MINUS_A_NUMBER("0100020400FF"), OBIS_DEMAND_PLUS_R_PERIOD("0100030400FF"), OBIS_DEMAND_PLUS_R_NUMBER("0100030400FF"), OBIS_DEMAND_MINUS_R_PERIOD("0100040400FF"), OBIS_DEMAND_MINUS_R_NUMBER("0100040400FF"), OBIS_DEMAND_R_QI_PERIOD(
				"0100050400FF"), OBIS_DEMAND_R_QI_NUMBER("0100050400FF"), OBIS_DEMAND_R_QIV_PERIOD("0100080400FF"), OBIS_DEMAND_R_QIV_NUMBER("0100080400FF"), OBIS_DEMAND_PLUS_PERIOD("0100090400FF"), OBIS_DEMAND_PLUS_NUMBER("0100090400FF"), OBIS_DEMAND_MINUS_PERIOD("01000A0400FF"), OBIS_DEMAND_MINUS_NUMBER("01000A0400FF"), PEROID("08"), NUMBER_OF_PERIODS("09"), OPTION_NOT_USE("00"); // 00은 Option 사용 하지 않겠다는 뜻.
	...
	public enum TOUAttributes {
		CLASS_ID("0014"), ACTIVITY_CALENDAR("00000D0000FF"), CALENDAR_NAME_PASSIVE("06"), SEASON_PROFILE_PASSIVE("07"), WEEK_PROFILE_TABLE_PASSIVE("08"), DAY_PROFILE_TABLE_PASSIVE("09"), ACTIVATE_PASSIVE_CALENDAR_TIME("0A") // 12byte 
		/*
