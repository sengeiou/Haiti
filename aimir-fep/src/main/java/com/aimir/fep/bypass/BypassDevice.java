...
public class BypassDevice {
	...
	//private String optTime; -> delete at NI Protocol 5.70
	// INSERT END SP-681	

	private TargetClass targetClass;
	private DeviceType otaTargetDeviceType;
	...
	public DeviceType getOtaTargetDeviceType() {
		return otaTargetDeviceType;
	}

	public void setOtaTargetDeviceType(DeviceType otaTargetDeviceType) {
		this.otaTargetDeviceType = otaTargetDeviceType;
	}
