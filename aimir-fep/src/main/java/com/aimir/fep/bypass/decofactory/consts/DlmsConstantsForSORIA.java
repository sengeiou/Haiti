 ...
 *
 */
public class DlmsConstantsForSORIA {
	private static Logger logger = LoggerFactory.getLogger(DlmsConstantsForSORIA.class);
	...
	public enum AARQ {
		...
		, CALLING_AP_TITLE(6, "A60A0408" + DlmsPiece.CLIENT_SYSTEM_TITLE.value) //  -- Client System Title  : NTC00001
		...
		, USER_INFORMATION(30, "BE10040E01000000065F1F040000181D0080")
		, APPLICATION(97, "60")
		, AARQ_LLC(98, "E6E600");
	 ...
	 */
	public enum AARE {
		PROTOCOL_VERSION(0x00), APPLICATION_CONTEXT_NAME(0xA1), RESULT(0xA2), RESULT_SOURCE_DIAGNOSTIC(0xA3)
		, RESPONDING_AP_TITLE(0xA4), RESPONDING_AE_QUALIFIER(0x05), RESPONDING_AP_INVOCATION_ID(0x06)
		, RESPONDING_AE_INVOCATION_ID(0x07), RESPONDER_ACSE_REQUIREMENTS(0x88), MECHANISM_NAME(0x89)
		, RESPONDING_AUTHENTICATION_VALUE(0xAA), IMPLEMENTATION_INFORMATION(0x1D), USER_INFORMATION(0xBE);
	...
	public enum ActionRequest {
		ACTION_REQUEST("C3"), ACTION_REQUEST_LLC("E6E600"), ACTION_REQUEST_INVOKE_ID_AND_PRIORITY("40")
	...
	public enum SetRequest {
		SET_REQUEST("C1"), SET_REQUEST_LLC("E6E600"), SET_REQUEST_INVOKE_ID_AND_PRIORITY("40"), NORMAL("01")
