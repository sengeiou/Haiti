 ...
 *
 */
public class NestedNIBypassDecoratorForIESCO extends NestFrameDecorator {
	private static Logger logger = LoggerFactory.getLogger(NestedNIBypassDecoratorForIESCO.class);
	 ...
	 * @param nestedFrame
	 */
	public NestedNIBypassDecoratorForIESCO(INestedFrame nestedFrame) {
		super(nestedFrame);
	}
...
//	}
	...
	public boolean isHdlcRRFrame() {
		...
		if ( nestedFrame != null && nestedFrame instanceof NestedHDLCDecoratorForIESCO ){
			NestedHDLCDecoratorForIESCO hdlcFrame = (NestedHDLCDecoratorForIESCO)nestedFrame;
