...
public class DLMSPolandSaver extends AbstractMDSaver {
	...
	protected boolean save(IMeasurementData md) throws Exception {
		DLMSPoland parser = (DLMSPoland) md.getMeterDataParser();
...
//			 }
	...
	private void saveEventLog(DLMSPoland parser) {
	    try {
    ...
    */
	...
	private boolean lpSave(IMeasurementData md, LPData[] validlplist,
			DLMSPoland parser, double base,double addBasePulse) throws Exception {
