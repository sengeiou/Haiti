...
public class ConfigurationEventChannel implements java.io.Serializable{
	...
	public String getCh_unit_Str() {
		...
		case 'A':
			unitStr="Amps";break;
		case 'D':
			unitStr="Angle in degrees";break;
		case 'H':
			unitStr="Hz";break;
		case 'M':
			unitStr="Minutes";break;
		case 'N':
			unitStr="No unit";break;
		case 'P':
			unitStr="Percent";break;
		case 'Q':
			unitStr="Power Factor";break;
		case 'R':
			unitStr="Vars";break;
		case 'S':
			unitStr="VA";break;
		case 'T':
			unitStr="Seconds";break;
		case 'U':
			unitStr="Unknown";break;
		case 'V':
			unitStr="Volts";break;
		case 'W':
			unitStr="Watts";break;
