...
public class MDHistoryData implements java.io.Serializable
{
     ...
     */
    public MDHistoryData(String mcuId,int entryCount, byte[] mdData, String ns, String ipAddr, String protocolType, String commTime)
    {
        this.mcuId = mcuId;
     ...
     * @param mdData - Measurement Data 
     */
    public MDHistoryData(int entryCount, byte[] mdData, String ns, String ipAddr, String protocolType, String commTime)
    {
        this.entryCount = entryCount;
        this.mdData = mdData;
        this.nameSpace = ns;
