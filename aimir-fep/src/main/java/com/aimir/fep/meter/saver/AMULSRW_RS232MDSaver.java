...
/**
 *
 * AMU 프로토콜을 사용하는 LS RW - RS232(Protocol:ANSI) 에 대한 검침 데이터 파서
 * @author kaze
 *
 */
@Service
public class AMULSRW_RS232MDSaver extends AbstractMDSaver {
	private static Log log = LogFactory.getLog(AMULSRW_RS232MDSaver.class);

	@Override
	protected boolean save(IMeasurementData md) throws Exception {
		AMULSRW_RS232 parser = (AMULSRW_RS232) md.getMeterDataParser();
