...
public class A2RL_MDM {
    ...
    private Log log = LogFactory.getLog(A2RL_MDM.class);
    ...
    public String toString()
    {
        ...
        try{
            ...
            log.warn("A2RL_MDM TO STRING ERR=>"+e.getMessage());
        }
