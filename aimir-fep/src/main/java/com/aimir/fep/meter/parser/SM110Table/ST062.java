 ...
 */
public class ST062 implements java.io.Serializable {

	private static final long serialVersionUID = 4391502635119851371L;
	...
	private byte[] data;
    private static Log log = LogFactory.getLog(ST062.class);
