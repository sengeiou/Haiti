package com.aimir.fep.meter.parser.DLMSClou3PTable;
...
public class DLMSVARIABLE {
    ...
    public enum ENERGY_LOAD_PROFILE {
    	Structure(0, "Structure"),
        Date(1, "Date"),        
        ActiveEnergyImport(2, "Cumulative Active Energy -Import"),
        ActiveEnergyExport(3, "Cumulative Active Energy -Export"),
        ReactiveEnergyImport(4, "Cumulative Reactive Energy -Import"),
        ReactiveEnergyExport(5, "Cumulative Reactive Energy -Export"),
        AverageDemandValueActiveImport(6, "Average Demand Value / Time of Active Power -Import"),
        AverageDemandValueActiveExport(7, "Average Demand Value / Time of Active Power -Export"),
        AverageDemandValueReactiveImport(8, "Average Demand Value / Time of Reactive Power -Import"),
        AverageDemandValueReactiveExport(9, "Average Demand Value / Time of Reactive Power -Export"),
        L1InstantVoltage(10, "L1 Instant Voltage"),
        L2InstantVoltage(11, "L2 Instant Voltage"),
        L3InstantVoltage(12, "L3 Instant Voltage"),
        L1InstantCurrent(13, "L1 Instant Current"),
        L2InstantCurrent(14, "L2 Instant Current"),
        L3InstantCurrent(15, "L3 Instant Current");
