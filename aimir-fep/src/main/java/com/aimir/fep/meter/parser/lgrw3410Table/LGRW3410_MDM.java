/* 
 * @(#)LGRW3410_MDM.java       1.0 2008-03-28 *
 * 
 * Modem Information.
...
public class LGRW3410_MDM {
    ...
    private static Log log = LogFactory.getLog(LGRW3410_MDM.class);
	 ...
	 */
	public LGRW3410_MDM(byte[] rawData) {
    ...
    public String toString()
    {
        ...
        try{
            sb.append("LGRW3410_MDM Meter DATA[");        
            ...
            log.warn("LGRW3410_MDM TO STRING ERR=>"+e.getMessage());
        }
