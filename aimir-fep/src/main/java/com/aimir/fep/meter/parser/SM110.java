 ...
 */
public class SM110 extends MeterDataParser implements java.io.Serializable
{
	private static final long serialVersionUID = -2628024232287867264L;
	private static Log log = LogFactory.getLog(SM110.class);
    ...
    public void parse(byte[] data) throws Exception
    {
        ...
        if(s052 != null){
            st052 = new ST055(s052);
            this.meterTime = st052.getDateTime();
            if(s003 != null)
        ...
        try
        {
            ...
            if(relayevlog != null && relayevlog.length > 0){
                ...
                for(int i = 0; i < relayevlog.length; i++){
                    ...
                    Date meterDate = normalDateFormat.parse(datetime+"00");
                    res.put(datef14.format(meterDate), relayevlog[i].getMsg());              
                }
            }
