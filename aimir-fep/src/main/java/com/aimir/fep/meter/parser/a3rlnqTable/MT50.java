...
public class MT50 implements java.io.Serializable {
	...
	/**
	 * PQM Power Frequency & Reverse Power Cumulative Duration.(seconds)
	 * 
	 * @return - 4 byte hex data.
	 * @throws Exception
	 */
	...
	/**
	 * PQM Power Frequency & Reverse Power Status.
	 * 
	 * @return
	 */
	...
	/**
	 * PQM THD(Total Harmonic Distortion) Current Cumulative count.
	 * 
	 * @return - 2 byte hex data.
	 * @throws Exception
	 */
	...
	/**
	 * PQM THD(Total Harmonic Distortion) Current Cumulative Duration.(seconds)
	 * 
	 * @return
	 * @throws Exception
	 */
	...
	/**
	 * PQM THD(Total Harmonic Distortion) Current status.
	 * 
	 * @return
	 */
	...
	/**
	 * PQM THD(Total Harmonic Distortion) Voltage Cumulative Count.
	 * 
	 * @return - 2 byte hex data.
	 * @throws Exception
	 */
	...
	/**
	 * PQM THD(Total Harmonic Distortion) Voltage Cumulative Duration.(seconds)
	 * 
	 * @return - 4 byte hex data.
	 * @throws Exception
	 */
	...
	/**
	 * PQM THD(Total Harmonic Distortion) Status.
	 * 
	 * @return
	 */
	...
	protected int getCumCount(int offset, int len) throws Exception {

		return DataFormat.hex2unsigned16(DataFormat.LSB2MSB(DataFormat.select(
				data, offset, len)));
	}

	protected long getCumDur(int offset, int len) throws Exception {

		return DataFormat.hex2long(DataFormat.LSB2MSB(DataFormat.select(data,
				offset, len)));
	}
	...
	protected int getCumStatus(int offset, int len) {
		...
		long fail_secs = 0;
		try {
			fail_secs = DataFormat.hex2long(DataFormat.LSB2MSB(DataFormat
					.select(data, offset, len)));
		} catch (Exception e) {
