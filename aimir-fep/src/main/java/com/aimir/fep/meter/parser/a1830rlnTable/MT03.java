 ...
 */
public class MT03 implements java.io.Serializable{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 7561680490920367378L;
	...
	*/
	private final int OFS_NBR_MANUAL_DEMANDRESET  = 67;
	private final int OFS_DEMANDRESET_MECH        = 69;
	private final int OFS_DAYS_SINCE_DEMAND_RESET = 70;
	private final int OFS_DAYS_SINCE_PULSE        = 71;
	private final int OFS_POWERFAILTIME           = 72;
	private final int OFS_POWERUPTIME             = 78;
	private final int OFS_CUM_POWEROUTAGE         = 84;
	private final int OFS_CUM_POWEROUTAGE_TIME    = 85;
