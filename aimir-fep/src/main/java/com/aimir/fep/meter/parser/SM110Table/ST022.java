 ...
 */
public class ST022 implements java.io.Serializable {

	private static final long serialVersionUID = -8975488700134766648L;
    ...
    private static Log log = LogFactory.getLog(ST022.class);
