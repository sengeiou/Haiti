...
public class KamstrupOmniPowerMDSaver extends AbstractMDSaver {
    ...
    public String relayValveOn(String mcuId, String meterId) {
        Object[] result = null;
        String[] meterModelProtocolType = getMeterModelProtocol(meterId);
        
        try {
            CommandGW commandGw = DataUtil.getBean(CommandGW.class);
            Protocol protocolType = null;
            if(meterModelProtocolType[1] != null) {
                protocolType = Protocol.valueOf(meterModelProtocolType[1]);
            }
            
            // relay released
            if(Protocol.SMS.equals(protocolType)) {
            	...
            	String[] res = {"SUCCESS : Send SMS Command(RelayOn)"};
            	result = res;
            } else {
            	result = KamstrupCIDMeta.getResult(commandGw.cmdKamstrupCID(mcuId, meterId, 
                        new String[] {KamstrupCIDMeta.CID.SetCutOffState.getCommand(),
                            KamstrupCIDMeta.CID.SetCutOffState.getArgs()[1][0] }), meterModelProtocolType[0]);
            	
            	if (result[0] != null && result[0].equals("Relays released for reconnection")) {
                    result = KamstrupCIDMeta.getResult(commandGw.cmdKamstrupCID(mcuId, meterId,
                            new String[] {KamstrupCIDMeta.CID.SetCutOffState.getCommand(),
                            KamstrupCIDMeta.CID.SetCutOffState.getArgs()[2][0] }), meterModelProtocolType[0]);
    ...
    public String relayValveOff(String mcuId, String meterId) {
        ...
        try {
            ...
            if(Protocol.SMS.equals(protocolType)) {
            	...
            	String[] res = {"SUCCESS : Send SMS Command(RelayOff)"};
            	result = res;
            } else {
                result = KamstrupCIDMeta.getResult(commandGw.cmdKamstrupCID(mcuId, meterId,
                        new String[] {KamstrupCIDMeta.CID.SetCutOffState.getCommand(),
                            KamstrupCIDMeta.CID.SetCutOffState.getArgs()[0][0] }), meterModelProtocolType[0]);
    ...
    public String relayValveStatus(String mcuId, String meterId) {
        ...
        try {
            ...
            if(Protocol.SMS.equals(protocolType)) {
            	...
            	String[] res = {"SUCCESS : Send SMS Command(RelayStatus)"};
            	result = res;
            } else {
	            result = KamstrupCIDMeta.getResult(commandGw.cmdKamstrupCID(mcuId, meterId,
	                            new String[] { KamstrupCIDMeta.CID.GetCutOffState.getCommand() }),
	                            meterModelProtocolType[0]);
            }
            for(Object o : result) {
                log.debug(o);
            }
    ...
    public String syncTime(String mcuId, String meterId) {
        ...
        try {
            ...
            CommandGW commandGw = DataUtil.getBean(CommandGW.class);
            Protocol protocolType = Protocol.valueOf(meterModelProtocol[1]);
            ...
            if(Protocol.SMS.equals(protocolType)) {
            	...
            	String[] res = {"SUCCESS : Send SMS Command(MeterTimeSync)"};
    ...
    public String relayValveActivate(String mcuId, String meterId) {
        ...
        try {
            ...
            result = KamstrupCIDMeta.getResult(commandGw.cmdKamstrupCID(mcuId, meterId, 
                    new String[] {KamstrupCIDMeta.CID.SetCutOffState.getCommand(),
                        KamstrupCIDMeta.CID.SetCutOffState.getArgs()[1][0] }), meterModelProtocol[0]);
        }
        catch (Exception e) {
            log.error(e, e);
            result = new String[]{e.getMessage()};
