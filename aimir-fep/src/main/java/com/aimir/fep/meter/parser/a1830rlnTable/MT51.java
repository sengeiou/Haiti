 ...
 */
public class MT51 implements java.io.Serializable{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 6114676335722699444L;
	 ...
	 * @return
	 */
	public String getMeterElement(byte[] temp) {
