/** 
 * @(#)MeterManufacture.java       1.0 07/11/09 *
 * 
...
public class MeterManufacture {
    ...
    public static final int OFS_METER_PROTOCOL  = 0;
    public static final int OFS_METER_VENDOR  = 1;
    public static final int OFS_METER_MAKE_TIME  = 2;
    public static final int OFS_METER_SERIAL  = 3;
