...
//		setMeteringValue();
	...
	public Instrument getInstrument() {  
		...
		try {
			double current_a = getDoubleFromLongOctet(result.get(OBIS.A_MAX_LOAD_ELECTRIC.getCode()));
			log.debug("CURRENT_A[" + current_a + "]");
			double voltage_a = getDoubleFromLongOctet(result.get(OBIS.DEFAULT_VOLTAGE_AB.getCode()));
			log.debug("VOLTAGE_A[" + voltage_a + "]");

			double current_b = getDoubleFromLongOctet(result.get(OBIS.B_MAX_LOAD_ELECTRIC.getCode()));
			log.debug("CURRENT_B[" + current_b + "]");
			double voltage_b = getDoubleFromLongOctet(result.get(OBIS.DEFAULT_VOLTAGE_BA.getCode()));
			log.debug("VOLTAGE_B[" + voltage_b + "]");

			double current_c = getDoubleFromLongOctet(result.get(OBIS.C_MAX_LOAD_ELECTRIC.getCode()));
			log.debug("CURRENT_C[" + current_c + "]");
			double voltage_c = getDoubleFromLongOctet(result.get(OBIS.DEFAULT_VOLTAGE_CA.getCode()));
