...
public class DLMSEtypeMDSaver extends AbstractMDSaver {
    ...
    public boolean save(IMeasurementData md) throws Exception {
        try {
            DLMSEtype parser = (DLMSEtype) md.getMeterDataParser();
    ...
    public void saveLPData(List<Double>[] chValue, List<Integer> flag, String startlpdate, double baseValue, DLMSEtype parser)
            throws Exception {
