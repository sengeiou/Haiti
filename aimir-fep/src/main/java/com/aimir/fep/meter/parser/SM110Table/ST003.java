 ...
 */
public class ST003 implements java.io.Serializable {

	private static final long serialVersionUID = 3931256449556690569L;
    ...
    private static final String[] STATUS_BIT_TRUE = 
    {
        ...
        "<dt>METERING ERROR</dt>",
        "<dt>Device did detect DC</dt>",
    ...
    public String getMeterLog(){
        ...
        eventlist = new ArrayList<EventLogData>();
        ...
        try{
            ...
            for(int i = 0; i < _status.length; i++){
                ...
                sb.append(StringUtil.reverse(convertStr));
            }
