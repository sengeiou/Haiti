...
public class A1800_LD implements java.io.Serializable{
	
    /**
	 * 
	 */
	private static final long serialVersionUID = 4887429174950826221L;
	private Log log = LogFactory.getLog(A1800_LD.class);
...
//	private ST62 st62 = null;
	...
	public A1800_LD(byte[] rawData, double ke, int meterConstantScale) {
...
//        LP Data
		...
		catch(Exception e){this.st64 = null;}
        if(this.st64 == null){
			log.debug("st64 is null");	
		}else{
			log.debug("st64 is NOT null");
		}
	}
