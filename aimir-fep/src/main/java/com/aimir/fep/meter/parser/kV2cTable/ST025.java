...
public class ST025 {
	...
	private void parseData() throws Exception {
		...
		int tou_blk_size 
			...
			+ tot_curdemand_size
			+ tot_coincident_size;		
        log.debug("tou_blk_size=["+tou_blk_size+"],nbr_sum=["+this.NBR_SUM+"],nbr_dmd=["+this.NBR_DMD+"],nbr_coin=["+this.NBR_COIN+"]");
