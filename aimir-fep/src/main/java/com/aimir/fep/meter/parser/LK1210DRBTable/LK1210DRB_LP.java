 ...
 */
public class LK1210DRB_LP implements java.io.Serializable{
    ...
    private static Log log = LogFactory.getLog(LK1210DRB_LP.class);
    
	/**
	 * Constructor .<p> 
	 * @param data - read data (header,crch,crcl)
	 */
	public LK1210DRB_LP(byte[] rawData, int regK, int resolution, int ctvt) {
