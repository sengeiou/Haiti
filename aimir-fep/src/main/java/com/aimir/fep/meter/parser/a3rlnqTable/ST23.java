...
public class ST23 implements java.io.Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 508577922999536170L;
...
//	displayscale = ADJ_KE_SCALE_FACTOR INT8
	private long energyscaleXdispmult ;
	 ...
	 */
	public ST23(byte[] data, int nbr_tiers, int nbr_sum, int nbr_dmd, int nbr_coin, long ke, int meterConstantScale) {
		this.data = data;
