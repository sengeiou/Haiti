...
import com.aimir.fep.meter.parser.a1830rlnTable.ST21;
import com.aimir.fep.meter.parser.a1830rlnTable.ST23;

public class A3_CB implements java.io.Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = 3000537368553595100L;
	...
	public A3_CB(byte[] rawData, long ke, int meterConstantScal) {
        this.rawData = rawData;
		parse(ke, meterConstantScal);
	}
	
	public void parse(long ke, int meterConstantScale) {
		int offset = 0;
