...
public class DLMSWtypeVARIABLE {
	private static Log log = LogFactory.getLog(DLMSWtypeVARIABLE.class);
    ...
    public enum OBIS {
        ...
        COLD_WATER("088080808080", "Cold Water");
