 ...
 *
 * @author  : taeho Park 
 * @version : $REV $1, 2010. 4. 22. 오후 5:24:45$
 */
...
private static Log log = LogFactory.getLog(CurrentTimeData.class);
    ...
    public int getTimeZone(){
        ...
        int ret =0;
        try{
        	ret = DataFormat.hex2signed16(DataFormat.select(rawData, OFS_TIME_ZONE,LEN_TIME_ZONE));
    ...
    public int getDstValue(){
        ...
        int ret = 0;
        try{
        	ret = DataFormat.hex2signed16(DataFormat.select(rawData, OFS_DST_VALUE,LEN_DST_VALUE));
    ...
    public int getYear(){
       ...
       int ret = 0;
       try{
    	   ret = DataFormat.hex2signed16(DataFormat.select(rawData, OFS_YEAR,LEN_YEAR));
