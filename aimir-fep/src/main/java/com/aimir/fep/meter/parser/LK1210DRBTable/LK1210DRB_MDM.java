/* 
 * @(#)LGRW3410_MDM.java       1.0 2008-04-16 *
 * 
 * Modem Information.
 ...
 */
public class LK1210DRB_MDM implements java.io.Serializable{
    ...
    private static Log log = LogFactory.getLog(LK1210DRB_MDM.class);
	 ...
	 */
	public LK1210DRB_MDM(byte[] rawData) {
    ...
    public String toString()
    {
        ...
        try{
            sb.append("LK1210DRB_MDM Meter DATA[");        
            ...
            log.warn("LK1210DRB_MDM TO STRING ERR=>"+e.getMessage());
        }
