/* 
 * @(#)LK1210DRB_EV.java       1.0 08/04/16 *
 * 
 * Event Log.
 ...
 */
public class LK1210DRB_EV implements java.io.Serializable{
    ...
    private static Log log = LogFactory.getLog(LK1210DRB_EV.class);
	 ...
	 */
	public LK1210DRB_EV(byte[] rawData, byte[] meterStatus) {
    ...
    private void parseEvent(){
        ...
        try {
        	...
        	log.error("LK1210DRB_EV parseEvent error",e);
        }
    }
