...
/**
 * ExportExcelGrid.java Description 
 * <p>
 * <pre>
 * Date          Version     Author   Description
 * 2012. 7. 30.  v1.0        문동규   Grid 데이터를 Excel 파일로 생성해주는 프로그램. 일반 Grid 범용으로 사용.
 * </pre>
 */
public class ExportExcelGrid {

    private List<String> headerList = null;
    private List<Integer> widthList = null;
    private List<String> alignList = null;
...
//    private String searchDateType = null;
    ...
    public static void main(String[] args) {
        ExportExcelGrid excel = new ExportExcelGrid();
...
//        excel.setSearchDateType("1");
     ...
     * @param fileName
     */
    public ExportExcelGrid(List<String> headerList, List<Integer> widthList, List<List<Object>> dataList,
            List<String> alignList, String title, Boolean isRowColor, String filePath, String fileName) {
...
//        System.out.println("data size:" + data.get(0).size());
        if (headerList != null && headerList.size() > 0 && dataList != null && dataList.size() > 0 && dataList.get(0) != null
                && dataList.get(0).size() > 0 && headerList.size() == dataList.get(0).size() && filePath != null && !filePath.isEmpty()
