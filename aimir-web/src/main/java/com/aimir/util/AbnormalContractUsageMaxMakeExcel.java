...
public class AbnormalContractUsageMaxMakeExcel {

	public AbnormalContractUsageMaxMakeExcel() {
	...
	public void writeReportExcel(List<Object> result,
		...
		try {
            ...
            cell = row.createCell(cellCnt++);
			cell.setCellValue(msgMap.get("tariffName"));
            cell.setCellStyle(title2CellStyle);
            
			cell = row.createCell(cellCnt++);
			cell.setCellValue(msgMap.get("contractUsage"));
            cell.setCellStyle(title2CellStyle);

			cell = row.createCell(cellCnt++);
			cell.setCellValue(msgMap.get("demandUsage"));
            cell.setCellStyle(title2CellStyle);
			...
			for (int i = 0; i < dataCount; i++) {
				...
				cell = row.createCell(cellCnt2++);
				cell.setCellValue(resultMap.get("contractUsage")==null?"":resultMap.get("contractUsage").toString());
            	cell.setCellStyle(dataCellStyle);
				
				cell = row.createCell(cellCnt2++);
				cell.setCellValue(resultMap.get("demandUsage")==null?"":resultMap.get("demandUsage").toString());
            	cell.setCellStyle(dataCellStyle);
