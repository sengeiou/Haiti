 ...
 *
 */
public class FacilitySituationDataMakeExcel {

    public FacilitySituationDataMakeExcel() {
    ...
    public void writeReportExcel(List<EndDeviceVO> result, Map<String, String> msgMap, boolean isLast, String filePath, String fileName) {
	    ...
	    try {
            ...
            final String reportTitle = "설비 운영 상태 보고서 ";
            ...
            cell.setCellValue(msgMap.get("dayEM"));
            cell.setCellStyle(titleCellStyle);
            
            cell = row.createCell(5);
            cell.setCellValue(msgMap.get("dayWM"));
            cell.setCellStyle(titleCellStyle);
            
            cell = row.createCell(6);
            cell.setCellValue(msgMap.get("dayGM"));
            cell.setCellStyle(titleCellStyle);
            
            cell = row.createCell(7);
            cell.setCellValue(msgMap.get("dayHM"));
            cell.setCellStyle(titleCellStyle);
            ...
            for(int i = 0 ; i < dataCount ; i++) {
            	...
            	cell = row.createCell(3);
            	cell.setCellValue(resultMap.getStatus());
            	cell.setCellStyle(dataCellStyle);

            	cell = row.createCell(4);
            	cell.setCellValue(resultMap.getDayEM());
            	cell.setCellStyle(dataCellStyle);

            	cell = row.createCell(5);
            	cell.setCellValue(resultMap.getDayWM());
            	cell.setCellStyle(dataCellStyle);

            	cell = row.createCell(6);
            	cell.setCellValue(resultMap.getDayGM());
            	cell.setCellStyle(dataCellStyle);

            	cell = row.createCell(7);
            	cell.setCellValue(resultMap.getDayHM());
            	cell.setCellStyle(dataCellStyle);
