    	...
    	$.ajaxSetup({
   	    ...
   	    $.getJSON('${ctx}/gadget/customer/getCustomerUsageMiniChartbySearchDate.do'
				...
				,function(json) {
                	 ...
                	 var dataset = "<dataset seriesName='<fmt:message key="aimir.usage"/>' color='"+fChartColor_Gas[0]+"'>";
...
<body>
	...
	<div class="gadget_body">
		...
		<form id="dataForm">
			<div>
				<table id="dataGridTitle" class="border-2px-gas datagrid-title">
                <colgroup>
                <col width="152px" />
                <col width="" />
                </colgroup>
			...
			<div class="border-2px-gas datagrid-data">
