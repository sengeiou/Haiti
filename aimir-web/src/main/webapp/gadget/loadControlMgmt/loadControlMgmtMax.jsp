    ...
    // create reusable renderer
       ...
       var mappingColModel = new Ext.grid.ColumnModel({
           columns: [
               ...
               {header: "Load Control Allow", dataIndex: 'MAPPINGDRPROGRAMMANDATORY', editor:combo,   // MAPPINGIMGURL
...
//        $.ajaxSetup({ async: false });
       ...
       var drHistoryStore = new Ext.data.JsonStore({
           ...
           url: "${ctx}/gadget/loadControlMgmt/getLoadControlHistoryMax.do?contractId=" + $("#contractNumber").val() + "&period="+periodVal,
          ...
          var comboBox = new Ext.form.ComboBox({
              ...
              listeners:{
                  select:function( combo, rec, index){
                          ...
                          $.getJSON("${ctx}/gadget/loadControlMgmt/getDemandResponseHistoryMax.do",
                                  params,
                                  function(result) { }
                          ); */
                  }                    
