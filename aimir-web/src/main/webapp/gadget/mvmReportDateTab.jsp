...
<script type="text/javascript" charset="utf-8">/*<![CDATA[*/
    ...
    function dateInit() {
      ...
      nextMonth = month == 11 ? 12 : (month + 1) % 12;
    ...
    function init(){
                ...
                ,function(json) {
                    ...
                    if(tabs.monthly!=0){
                      $('#monthlyYearCombo').numericOptions({
                        from: nextMonthYear - 9,
                        to: nextMonthYear, 
                        selectedIndex: 9});
                      $('#monthlyYearCombo').selectbox();
                      getMonthlyMonthCombo(year,month);
                    }
        ...
        // 검색버튼 표시
        if(tabs.search_yearly==1)        showSearchBtn('yearlySearch');
        if(tabs.search_seasonal==1)      showSearchBtn('seasonalSearch');
        if(tabs.search_weekDaily==1)     showSearchBtn('weekDailySearch');
        if(tabs.search_monthlyPeriod==1) showSearchBtn('monthlyPeriodSearch');
        if(tabs.search_monthly==1)       showSearchBtn('monthlySearch');
        if(tabs.search_weekly==1)        showSearchBtn('weeklySearch');
        if(tabs.search_period==1)        showSearchBtn('periodSearch');
        if(tabs.search_daily==1)         showSearchBtn('dailySearch');
        if(tabs.search_hourly==1)        showSearchBtn('hourlySearch');
    ...
    function monthlyArrow(val){
      ...
      if(NumberUtil.to2Digit) {
        nextMonthStr = NumberUtil.to2Digit(nextMonth);
      } else if(nextMonth < 10) {
        nextMonthStr = "0" + nextMonth;
      }
      var basicDate = String(nextMonthYear) + nextMonthStr + "01";
      $.getJSON("${ctx}/common/getYearMonth.do"
        ,{year:$('#monthlyYearCombo').val(),
          ...
          $('#monthlyYearCombo').selectbox();
          getMonthlyMonthCombo(json.year, json.month);
      });
    }
     ...
     */
    function getMonthlyMonthCombo(selectedYear, selectedMonth){
      var month;
      var lastMonth;
      $('#monthlyMonthCombo').selectbox("detach");
      if ( nextMonthYear == selectedYear ) {
        lastMonth = nextMonth;
      } else {
        lastMonth = 12;
      }
      ...
      $('#monthlyMonthCombo').numericOptions({
        from: 1,
        to: lastMonth, 
        selectedIndex: lastMonth -1
      });
      
      $('#monthlyMonthCombo').val(selectedMonth || lastMonth);
      $('#monthlyMonthCombo').selectbox();
      getSearchDate(DateType.MONTHLY, true);
    }
        ...
        $.getJSON("${ctx}/common/getSeason.do"
                ...
                ,function(json) {
                    ...
                    if(json.Spring.name == Season.SPRING){
                    	season[seasonIdxs++] = 1 + ' <fmt:message key="aimir.quarter"/>';
                    ...
                    if(json.Summer.name == Season.SUMMER){
                        season[seasonIdxs++] = 2 + '<fmt:message key="aimir.quarter"/>';
                    ...
                    if(json.Autumn.name == Season.AUTUMN){
                        season[seasonIdxs++] = 3 + '<fmt:message key="aimir.quarter"/>';
                    ...
                    if(json.Winter.name == Season.WINTER){
                        season[seasonIdxs++] = 4 + '<fmt:message key="aimir.quarter"/>';
    ...
    function getSearchDate(_dateType,flag){
        ...
        if(DateType.HOURLY == _dateType){
          ...
          $.getJSON("${ctx}/common/getFullMonthlyPeriod.do"
            ,{year:$('#monthlyYearCombo').val(),
              month:$('#monthlyMonthCombo').val(),
              supplierId:_supplierId}
            ,function(json) {
...
<!-- Tab (S) -->
<div id="datetab" class="buttontype" style="display:none; padding-top:0 !important">
    <div id="hourly">
	    ...
	    <div id="btn">
	        <ul><li id="hourlySearchLi"><a href="#;" id="hourlySearch" class="on"><fmt:message key="aimir.button.search" /></a></li></ul>
	    </div>
    </div>
    ...
    <div id="daily">
        ...
        <div id="btn">
            <ul><li id="dailySearchLi"><a href="javascript:searchInfo();" id="dailySearch" class="on"><fmt:message key="aimir.button.search" /></a></li></ul>
        </div>
    </div>
    ...
    <div id="period">
        ...
        <div id="btn">
            <ul><li id="periodSearchLi"><a href="#;" id="periodSearch" class="on"><fmt:message key="aimir.button.search" /></a></li></ul>
        </div>
    </div>
    ...
    <div id="weekly">
        ...
        <div id="btn">
            <ul><li id="weeklySearchLi"><a href="javascript:searchInfo();" id="weeklySearch" class="on"><fmt:message key="aimir.button.search" /></a></li></ul>
        </div>
    </div>
    ...
    <div id="monthly">
        ...
        <div id="btn">
            <ul><li id="monthlySearchLi"><a href="javascript:searchInfo();" id="monthlySearch" class="on"><fmt:message key="aimir.button.search" /></a></li></ul>
        </div>
    </div>
    ...
    <div id="monthlyPeriod">
        ...
        <div id="btn">
            <ul><li id="monthlyPeriodSearchLi"><a href="#;" id="monthlyPeriodSearch" class="on"><fmt:message key="aimir.button.search" /></a></li></ul>
        </div>
    </div>
    ...
    <div id="seasonal">
        ...
        <div id="btn">
            <ul><li id="seasonalSearchLi"><a href="javascript:searchInfo();" id="seasonalSearch" class="on"><fmt:message key="aimir.button.search" /></a></li></ul>
        </div>
    </div>
    <div id="yearly">
        ...
        <div id="btn">
            <ul><li id="yearlySearchLi"><a href="javascript:searchInfo();" id="yearlySearch" class="on"><fmt:message key="aimir.button.search" /></a></li></ul>
        </div>
    </div>
