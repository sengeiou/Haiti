    ...
    function getSearchDate(_dateType,flag){
        ...
        if(DateType.HOURLY == _dateType){
            ...
            $.getJSON("${ctx}/common/getMonthPeriod.do"
                    ,{year:$('#monthlyYearCombo').val(),month:$('#monthlyMonthCombo').val(), supplierId:_supplierId}
                    ,function(json) {
                        $('#searchStartDate').val(json.startDate);
                        $('#searchEndDate').val(json.endDate);
                        convertSearchDate();
...
<div id="datetab" class="buttontype" style="display:none; padding-top:0 !important">
    ...
    <div id="period">
        ...
        <ul style="width: 300px">
            <li style="padding-right: 300px"><select id="periodType" style="width: 65px"></select></li>
           <!--  <li class="date-space"></li> -->
