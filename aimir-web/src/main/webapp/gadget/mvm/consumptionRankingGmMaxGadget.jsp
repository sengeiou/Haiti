...
<head>
    ...
    <script type="text/javascript">
        ...
        var serviceType = ServiceType.Gas;
        ...
        function getFmtMessage(){
            ...
            fmtMessage[11] = "GM";                                              // 미터타입
            fmtMessage[12] = "<fmt:message key="aimir.firmware.msg09"/>";       // excel export 조회데이터 없음.
            fmtMessage[13] = "<fmt:message key="aimir.excel.consumRankingGm"/>";
        ...
        function openExcelReport() {
            ...
            if(win)
                win.close();
            win = window.open("${ctx}/gadget/mvm/consumptionRankingExcelDownloadPopup.do", "ConsumptionRankingGmExcel", opts);
            win.opener.obj = obj;
        }
