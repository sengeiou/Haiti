...
<head>
    ...
    <script type="text/javascript" >/*<![CDATA[*/
        ...
        //탭초기화
             var tabs = {hourly:1,daily:1,period:0,weekly:0,monthly:0,monthlyPeriod:0,weekDaily:0,seasonal:0,yearly:0};
        ...
        function getParams() {
            ...
            condArray[cnt++] = $('#searchStartHour').val();
            condArray[cnt++] = $('#searchEndHour').val();
        ...
        function updateFailureChart(locationId, isParent) {
            ...
            $.getJSON('${ctx}/gadget/mvm/getMbusSlaveIoCountListPerLocation.do'
        ...
        function getmeteringSuccessMiniGrid(){
            ...
            var width = $("#resultListGridDiv").width(); 
             ...
             meteringSuccessMiniGridStore = new Ext.data.JsonStore({
                ...
                url: "${ctx}/gadget/mvm/getMeteringNMSuccessRateListWithChildren.do",
                baseParams:{
                    ...
                    searchStartHour  : arrayObj[4],
                    searchEndHour    : arrayObj[5],  
                    supplierId       : arrayObj[6],
                    permitLocationId : arrayObj[7]
                },
               // totalProperty: 'total',
