...
<head>
    ...
    <script type="text/javascript">
        ...
        function getpowerQualityFmtMessage(){
            ...
            fmtMessage[4]  = "<fmt:message key="aimir.powerQuality.L1"/>"; // L1
            fmtMessage[5]  = "<fmt:message key="aimir.powerQuality.L2"/>"; // L2
            fmtMessage[6]  = "<fmt:message key="aimir.powerQuality.L3"/>"; // L3
            ...
            fmtMessage[10] = "<fmt:message key="aimir.alert"/>";
            fmtMessage[11]  = "<fmt:message key="aimir.firmware.msg09"/>"; // excel export 조회데이터 없음.
        ...
        function getPowerQualityGrid(){
			...
			if(firstLoadVol) {
             ...
             powerQualityGridStore = new Ext.data.JsonStore({
                ...
                url: "${ctx}/gadget/mvm/getPowerQualityListForSoria.do",
                baseParams:{
                ...
                { name: 'volL1_min', type: 'String' },
                { name: 'volL1_max', type: 'String' } ,
                { name: 'volL1_avg', type: 'String' } ,
                { name: 'volL2_min', type: 'String' },
                { name: 'volL2_max', type: 'String' } ,
                { name: 'volL2_avg', type: 'String' } ,
                { name: 'volL3_min', type: 'String' },
                { name: 'volL3_max', type: 'String' } ,
                { name: 'volL3_avg', type: 'String' }
                ],
                listeners: {
           	...
           	$.ajax({
		            ...
		            success:function(json, status) {
    	                ...
    	                fcChartDataXml = "<chart "
    	                    ...
    	                    + "showLabels='1' "
    	                    + "showLegend='1' "
    	                    + "labelStep='"+parseInt(list.length / 6, 10)+"' "
