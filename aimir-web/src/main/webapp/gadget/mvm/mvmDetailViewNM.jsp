...
<head>
    ...
    <script type="text/javascript" charset="utf-8">/*<![CDATA[*/
        ...
        function updateFChart() {
            ...
            $.getJSON("${ctx}/gadget/mvm/getDetailNetStationMonitaringDataChart.do"
                    ,{searchType : searchType,
            ...
            if (detailChartType == "column") {
                ...
                //fcChart = new FusionCharts("${ctx}/flexapp/swf/fcChart/Scatter.swf", "myChartId", $('#fcChartDiv').width(), "250", "0", "0");
                    ...
                    function updateFChartRate(json) {
                        //            console.log("updateFChartRate",json);
                        var searchData = json.searchData;
                        var searchTotalData = json.searchTotalData;
                        var labelStep = 1;

                        fcChartDataXml = "<chart " + "chartLeftMargin='5' "
                                + "chartRightMargin='10' "
                                + "chartTopMargin='10' "
                                + "chartBottomMargin='10' " + "showValues='0' "
                                + "showLabels='1' " + "showLegend='1' "
                                + "useRoundEdges='0' "
                                + "legendPosition='RIGHT' "
                                + "labelDisplay='ROTATE' " + "slantlabels='1' ";
                        +"labelStep='" + labelStep + "' "
                        //+ "decimals='3' "
                        + "forceDecimals='1' " + "toolTipSepChar='{br}' "
                        ...
                        var rateTotal1 = (searchTotalData == null || searchTotalData.total0 == null) ? "0"
                                : searchTotalData.total0;
                        var rateTotal2 = (searchTotalData == null || searchTotalData.total1 == null) ? "0"
                                : searchTotalData.total1;
                        var rateTotal3 = (searchTotalData == null || searchTotalData.total2 == null) ? "0"
                                : searchTotalData.total2;
                        ...
                        var datasets = new Array(seriesSize);
                        datasets[0] = "<dataset seriesName='<fmt:message key='aimir.customer.usage.rate1'/> = "
                                + rateTotal1 + " " + unit + " '>";
                        datasets[1] = "<dataset seriesName='<fmt:message key='aimir.customer.usage.rate2'/> = "
                                + rateTotal2 + " " + unit + " '>";
                        datasets[2] = "<dataset seriesName='<fmt:message key='aimir.customer.usage.rate3'/> = "
                                + rateTotal3 + " " + unit + " '>";
                    ...
                    function showReport(format) {
                        ...
                        var selectedIndex = $("#datetab").tabs("option",
                                "selected");
                        var report;
                        if (selectedIndex == 0)
                            report = "meteringDataMgmtRate.rptdesign";
                        else
                            report = "meteringDataManagement.rptdesign";
                        ...
                        if (format == "html") {
                            ...
                            var url = "/birt-viewer/output?__report="
                                    + report
                                    + params
        ...
        function getDetailDataList() {
            ...
            $.post("${ctx}/gadget/mvm/getDetailNetStationMonitaringData.do",
                    params,
                    function(json) {
...
<input type="hidden" id="meterNo" name="meterNo" value="${meterNo}">
...
<!--  
<div style="float:right;" id ="btn" class ="btn_right_top2"><a href="javascript:openDetailExcelReport()" class="btn_blue"><span><fmt:message key="aimir.button.excel"/></span></a></div>
-->
<!-- birt - jdk 1.7까지만 호환되기때문에 birt 로직 주석처리 (사용못함) -->
...
<div class="mvm-custinfo radius6">
    <table class="wfree table_detail" style="width:99%;">
        ...
        <tr>
            ...
            <td style="width:20% !important;"><input type="text" readonly value="${meterType}" class="border-trans bg-trans" style="width:100%;"></td>
            <th style="width:20% !important;"><fmt:message key="aimir.meterid"/></th>
            <td style="width:15% !important;"><input type="text" readonly value="${meterNo}" class="border-trans bg-trans" style="width:100%;"></td>
            <th style="width:13% !important;"><fmt:message key="aimir.mcuid2"/></th>
            <td style="width:20% !important;"><input type="text" readonly value="${mcuId}" class="border-trans bg-trans" style="width:100%;"></td>
        </tr>
        <tr>
           <th style="width:13% !important;"><fmt:message key="aimir.meteringtime"/></th>
            <td style="width:20% !important;"><input type="text" readonly value="${slaveInfo.lastUpdateTime}" class="border-trans bg-trans" style="width:100%;"></td>
            <th style="width:20% !important;"><fmt:message key="aimir.nm.digital"/></th>
            <td style="width:15% !important;"><input type="text" readonly value="${slaveInfo.degital}(${slaveInfo.degitalHex})" class="border-trans bg-trans" style="width:100%;"></td>
         </tr>
         <tr>
            <th style="width:13% !important;"><fmt:message key="aimir.nm.analog.current"/></th>
            <td style="width:20% !important;"><input type="text" readonly value="${slaveInfo.analogCurrent}" class="border-trans bg-trans" style="width:100%;"></td>
            <th style="width:20% !important;"><fmt:message key="aimir.nm.converted"/>&nbsp;<fmt:message key="aimir.nm.analog.current"/></th>
            <td style="width:15% !important;"><input type="text" readonly value="${slaveInfo.analogCurrentCnv}" class="border-trans bg-trans" style="width:100%;"></td>
         </tr>
         <tr>
            <th style="width:13% !important;"><fmt:message key="aimir.nm.analog.voltage"/></th>
            <td style="width:20% !important;"><input type="text" readonly value="${slaveInfo.analogVoltage}" class="border-trans bg-trans" style="width:100%;"></td>
            <th style="width:20% !important;"><fmt:message key="aimir.nm.converted"/>&nbsp;<fmt:message key="aimir.nm.analog.voltage"/></th>
            <td style="width:15% !important;"><input type="text" readonly value="${slaveInfo.analogVoltageCnv}" class="border-trans bg-trans" style="width:100%;"></td>
         </tr>
    </table>
</div>
...
<div id="conditionDiv" class="search-bg-withtabs" style="height:98px;">
    ...
    <%@ include file="../commonDateTabDetailViewNM.jsp" %>
    </div>
...
<div id="chartGridDiv" class="gadget_body">
    <div id="fcChartDiv" style="height:260px;">
