...
<head>
    ...
    <title><fmt:message key="aimir.consumptionRanking"/>(<fmt:message key="aimir.heatmeter"/>)</title>
    ...
    <script type="text/javascript">
        ...
        var serviceType = ServiceType.Heat;
        ...
        function getFmtMessage(){
            ...
            fmtMessage[2] = "<fmt:message key="aimir.usage"/> [㎥]";            // 사용량
            ...
            fmtMessage[11] = "HM";                                              // 미터타입
            fmtMessage[12] = "<fmt:message key="aimir.firmware.msg09"/>";       // excel export 조회데이터 없음.
            fmtMessage[13] = "<fmt:message key="aimir.excel.consumRankingHm"/>";
        ...
        function openExcelReport() {
            ...
            win = window.open("${ctx}/gadget/mvm/consumptionRankingExcelDownloadPopup.do", "ConsumptionRankingHmExcel", opts);
            win.opener.obj = obj;
        }
        ...
        <div class="searchoption-container">
            <table class="searchoption wfree">
                <tr>
                    ...
                    <td class="hidden"><input id="rankingType" name="rankingType" type="hidden" value="best"></td>
                </tr>
                <tr>
                    ...
                    <!-- <td id="usageArea" class="space20"></td> -->
                    <td class="withinput"id="usageArea"><fmt:message key="aimir.usage.section"/></td>
                    <td class="padding-r20px"><input id="usageList" name="usageList" type="text" style="width:100px"></td>
