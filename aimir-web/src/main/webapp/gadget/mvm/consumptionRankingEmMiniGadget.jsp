...
<meta http-equiv="Expires" content="-1">
    ...
    <script type="text/javascript" charset="utf-8">/*<![CDATA[*/
        ...
        function getFmtMessage() {
            ...
            fmtMessage[3] = "<fmt:message key='aimir.usage.kwh'/>";       // 사용량
    ...
    <div class="search-bg-withouttabs with-dayoptions-bt">
        ...
        <div class="searchoption-container">
            <table class="searchoption wfree">
                <tr>
                    <td class="hidden"><input id="rankingType" type="hidden" value=""></input></td>
            ...
            <table class="searchoption wfree">
                <tr>
                    ...
                    <td id="rangeInput"><input id="usageList" type="text" style="width:49px"></input></td>
                    <td id="rangeCombo"><select id="usageRangeCombo" style="width: 150px;"></select></td>
