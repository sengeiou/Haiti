...
<head>
    ...
    <script type="text/javascript">
        ...
        function getFmtMessage(){
            ...
            fmtMessage[13] = "<fmt:message key="aimir.excel.consumRankingWm"/>";
        ...
        function openExcelReport() {
            ...
            if(win)
                win.close();
            win = window.open("${ctx}/gadget/mvm/consumptionRankingExcelDownloadPopup.do", "ConsupmtionRankingWmExcel", opts);
            win.opener.obj = obj;
        }
