...
<head>
	...
	<script type="text/javascript">
	   	    ...
	   	    $.getJSON('${ctx}/gadget/mvm/getBillingFusionChartData.do'
					...
					,function(json) {
                        ...
                        for( var index =0; index<list.length;index++){
	                         if(index != "indexOf") {
	                         	labels	+= "<set label='"+list[index].locationName+"' value='"+list[index].kwh+"'  color='"+fChartColor_Water[0]+"' />";
	                         }
                        }

                        if(list.length == 0) {
                       	 	labels	= "<set label=' ' value='0' color='"+fChartColor_Water[0]+"' />";
                        }
        ...
        var getcustomerFmtMessage = function() {
            ...
            fmtMessage[9] = "<fmt:message key="aimir.excel.elecBillingWm"/>";
