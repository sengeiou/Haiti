...
<script type="text/javascript" charset="utf-8">/*<![CDATA[*/
	var eventHandler = {
		receiptPrint: function() {
			...
			logo += window.location.origin + "${ctx}/images/HAITI_logo.jpg\" width=\"75\" height=\"60\" float=\"right\"  />";
			...
			var print = function() {
				if(document.jzebra && document.jzebra.findPrinter) {
					...
					if(html.indexOf('<img class="logo" src="${ctx}/images/HAITI_logo.jpg">') > -1) {
						//html = html.replace('<img class="logo" src="${ctx}/images/ECG_logo.gif">', logo);
						html = html.replace('<img class="logo" src="${ctx}/images/HAITI_logo.jpg">', logo);
					}
		...
		<div class="logo-wrapper">
			...
			<table>
				<tr>
					...
					<td rowspan=4>
						<img class="logo" src="${ctx}/images/HAITI_logo.jpg"/>
					</td>
				</tr>
				<tr>
					<td>${name}</td>
