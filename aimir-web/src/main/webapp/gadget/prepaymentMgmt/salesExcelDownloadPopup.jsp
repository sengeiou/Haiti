...
<script type="text/javascript" charset="utf-8">/*<![CDATA[*/
  ...
  $(document).ready(function(){
    var params =  {
    	reportType: opener.reportType,
    	dVendorId : $$.find("#dailyListForm select[name=depositVendorList]").val(),
    	mVendorId : $$.find("#monthlyListForm select[name=depositVendorList]").val(),
    	supplierId: opener.supplierId,
      searchDate: $$.find("input[name=searchDate]").val(),
      startDate: $$.find("input[name=startDate]").val(),
      endDate: $$.find("input[name=endDate]").val(),
      filePath: '/reportExcel'
    };
    emergePre();

    $.post('${ctx}/gadget/prepaymentMgmt/dailyListExcelMake.do', params,
     function(json) {
      hide();
      if (json.total == 0) {
      	$("#datalist").hide();
