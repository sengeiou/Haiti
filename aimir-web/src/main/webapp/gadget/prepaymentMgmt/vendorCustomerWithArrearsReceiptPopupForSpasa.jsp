            ...
            <table border='1' width='200'><tr><td>
                <table border='0'>
                    <tr>
                        ...
                        <td rowspan=4>
                            <img class="logo" src="${ctx}/images/Spasa_logo.jpg"/>
                        </td>
                    </tr>
                    <tr>
                        <td>${vendorName}</td>
    ...
    <script type="text/javascript" charset="utf-8">/*<![CDATA[*/
        ...
        var eventHandler = {
            receiptPrint: function() {
                ...
                var logo = "<img src=\"";
                logo += window.location.origin + "${ctx}/images/Spasa_logo.jpg\" width=\"60\" height=\"60\" />";
                ...
                var print = function() {
                    if(document.jzebra && document.jzebra.findPrinter) {
                        ...
                        if(html.indexOf('<img class="logo" src="${ctx}/images/Spasa_logo.jpg">') > -1) {
                            html = html.replace('<img class="logo" src="${ctx}/images/Spasa_logo.jpg">', logo);
                        }
