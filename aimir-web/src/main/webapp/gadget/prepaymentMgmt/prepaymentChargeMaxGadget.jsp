...
<head>
    ...
    <script type="text/javascript" charset="utf-8">/*<![CDATA[*/
        ...
        function getHistoryFmtMessage() {
            ...
            //fmtMessage[idx++] = "<fmt:message key="aimir.hems.prepayment.usedcredit"/>(<fmt:message key='aimir.price.unit'/>)";    // 6. 사용금액(원)
            //fmtMessage[idx++] = "<fmt:message key="aimir.hems.prepayment.consumption"/>(kWh)";           // 7. 사용 전력량
        ...
        var getPrepaymentChargeList = function() {
            ...
            prepaymentChargeColModel = new Ext.grid.ColumnModel({
                columns: [
                   ...
                   ,{header: fmtMessage[7], dataIndex: 'chargeAmount', align: 'right', hidden: hiddenCol,
                   ...
                   ,{header: "", align: 'center', width: 80-chromeColAdd, renderer: renderSaveBtn, hidden: hiddenCol}
                ],
                defaults: {
                    sortable: true
                   ,menuDisabled: true
        ...
        var getChargeHistoryList = function() {
            ...
            chargeHistoryColModel = new Ext.grid.ColumnModel({
                columns: [
                    ...
                    ,{header: historyMessage[5], dataIndex: 'municipalityCode', width: colWidth-4}
                    ,{header: "", align: 'center', width: 80-chromeColAdd, renderer: renderReceiptBtn}
                ],
                defaults: {
                     sortable: true
                    ,menuDisabled: true
        ...
        function openReceiptPopup(rec) {
          ...
          var opts="width=350px, height=615px, resizable=no, status=no";
          var obj = new Object();

          obj.supplierId = supplierId;
          obj.contractId = rec.get("contractId");
          obj.prepaymentLogId = rec.get("prepaymentLogId");
          var queryString = CommonUtil.getQueryString(obj);
          if(win)
        	  win.close();
          win = window.open(url + queryString, "ReceiptPopup", opts);
          win.opener.obj = obj;
        }
...
<body>
    ...
    <%-- <div class="balancebox">
        <div class="title_basic" style="vertical-align: middle !important;"><span class="icon_title_blue"></span><fmt:message key='aimir.prepayment.balancehistory'/></div>
        <div class="saving_goal">
             <table>
                <tr>
                    <td><select id="fromYearCombo" style="width:60px"></select></td>
                    ...
                    <td><a href="#" class="btn_blue" onclick="openExcelReport();"><span><fmt:message key='aimir.button.excel'/></span></a></td>
                </tr>
            </table>
