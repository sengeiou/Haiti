<%--
  @ Date: 16-07-22
  @ Sub Page For MeterMaxGadget.jsp
  @ Insert to (<!-- Tab 4 : schedule (S) -->)
...
<!-- SCRIPT -->
<script>
    if(meterType == "WaterMeter" || meterType == "GasMeter"){
        $('#energyMeterSchedule').hide();
        $('#pulseMeterSchedule').show();
    }else{
        $('#energyMeterSchedule').show();
        $('#pulseMeterSchedule').hide();
    }
</script>
<!-- 1. Pulse Type (S) -->
<div id="pulseMeterSchedule">
    <ul><li>
        <!-- search-default (S) -->
...
<!-- 2. Energy Type (S) -->
<div id="energyMeterSchedule" class="blueline" style="height:490px;">
    ...
    <ul class="width">
        ...
        <table class="wfree margin-t10px">
            <tr>
                <th><label class="blue12pt">Hour </label></th>
                <td><input id="transmitHour" type="text" style="width:35px;"/></td>
                <th><label class="blue12pt"> Minute </label></th>
                <td><input id="transmitMinute" type="text" style="width:35px;"/></td>
                <th><label class="blue12pt"> Second </label></th>
                <td><input id="transmitSecond" type="text" style="width:35px;"/></td>
                <td><label id="transmitComment" class="red11pt"> </label></td>
            </tr>
        </table>
        <div class="margin-t2px margin-b3px">
            <label id="transmitUpdateResult" class="bluebold12pt" >Update Result : </label>
            <br>
            <label class="blue12pt">* Upload LP data at specific period. (Usually every 60 minutes.)</label>
        </div>
        <div class="headspace" style="width:100%;">
            <em class="am_button"><a href="javascript:getTrsFrequencyAction();"><fmt:message key="aimir.get"/></a></em>
