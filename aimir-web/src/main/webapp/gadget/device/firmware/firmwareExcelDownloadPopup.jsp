...
<head>
    ...
    <script type="text/javascript" charset="utf-8">/*<![CDATA[*/
        ...
        $(document).ready(function(){
            ...
            $.post('${ctx}/gadget/device/getFirmwareExportExcel.do',
                    {
 ...
 */
        ...
        function getExportExcelHeader() {
            ...
            headerMsg[cnt++] = '<fmt:message key="aimir.deviceId"/>';	 		// deviceId
            headerMsg[cnt++] = '<fmt:message key="aimir.deviceId"/> (parent)'; 	// deviceId(parent)
            headerMsg[cnt++] = '<fmt:message key="aimir.mcucode.fmversion"/> (parent)'; // fw ver(parent)
            headerMsg[cnt++] = 'Unable to Clone-On from Parent'; 
