	   ...
	   <form id="modemInfoForm">
	            ...
	            <table class="wfree" id="tableEdit" style="display:none">
		            <tr>
		            	...
		            	<th>IP</th>
	                    <td>
	                    	<input type="text" id="ipAddr" name="ipAddr" value="${modem.ipAddr}"/>
	                    </td>
	                    <th>Port</th>
	                    <td><input type="text" id="sysPort" name="sysPort" value="${modem.sysPort}"/></td>
		            </tr>
	            </table>
				<div class="clear">
       ...
       <form id="modemInfoForm">
                ...
                <table class="wfree" id="tableView" style="display:none">
       				<tr>
	            		...
	            		<th>IP</th>
	                    <td><input type="text" class="border-trans" readonly="readonly" value="${modem.ipAddr}" /></td>
	                    <th>Port</th>
	                    <td><input type="text" class="border-trans" readonly="readonly" value="${modem.sysPort}" /></td>
                	</tr>
                </table>
