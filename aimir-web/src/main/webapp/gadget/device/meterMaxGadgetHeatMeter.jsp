...
<div class="headspace">
    ...
    <span class="nocheck orange11pt"> Heat</span>
</div>
                ...
                <div  id="meterInstallInfoEdit" class="w_auto" style="margin-left:165px">
                    <table id="meterInstallInfoEditTable" class="wfree">
                        ...
                        <tr>
                            ...
                            <!-- <th class="withinput"><fmt:message key="aimir.consumptionlocation"/></th> -->
                            <th></th>
                            <td></td>
                        </tr>
                        <tr>
                            <th class="withinput"><b><fmt:message key="aimir.flowPerUnitPulse"/></b></th>
                                    <c:choose>
                                        <c:when test="${not empty meter.flowPerUnitPulse}">
                                        <td class="padding-r20px"><span class="input-fake">${meter.flowPerUnitPulse}</span></td></c:when>
                                    <c:otherwise>
                                <td class="padding-r20px"><input type="text"    class="input-fake" value="-" readonly="readonly">
                            </c:otherwise>
                            </c:choose>
                        ...
                        <tr>
                            <th class="withinput"><b><fmt:message key="aimir.apparatusRoomNumber"/></b></th>
                                   <c:choose>
                                        <c:when test="${not empty meter.apparatusRoomNumber}">
                                        <td><span class="input-fake">${meter.apparatusRoomNumber}</c:when>
                                        <c:otherwise>
                                <td class="padding-r20px"><input type="text"    class="input-fake" value="-" readonly="readonly">
                            </c:otherwise>
                            </c:choose>
                        ...
                        <tr>
                            ...
                            <td class="padding-r20px">
                               <c:choose>
                                    ...
                                    <c:otherwise>
                                        <input class="textBox-width-140" type="text"   id="pulseConstant"       value="" name="pulseConstant"  />
                                        <input type="hidden" id="pulseConstantHidden" value="" />
                                    </c:otherwise>
                                </c:choose>
                            </td>
                            <!-- <th class="withinput"><fmt:message key="aimir.consumptionlocation"/></th> -->
...
<!--
                        <tr>
                            <th class="withinput"><fmt:message key="aimir.heatType"/></th>
                            <td class="padding-r20px">
                                <c:choose>
                                    <c:when test="${not empty meter}">
                                        <input type="text"   id="heatType"        value="${meter.heatType}" name="heatType.id"/>
                                        <input type="hidden" id="heatTypeHidden"  value="${meter.heatType}" />
                                    </c:when>
                                    <c:otherwise>
                                        <input type="text"   id="heatType"        value="" name="heatType"/>
                                        <input type="hidden" id="heatTypeHidden"  value=""/>
                                    </c:otherwise>
                                </c:choose>
                            </td>
                            <th class="withinput"><fmt:message key="aimir.meteringUnit"/></th>
                            <td class="padding-r20px">
                               <c:choose>
                                    <c:when test="${not empty meter}">
                                        <input type="text"   id="meteringUnit"       value="${meter.meteringUnit}" name="meteringUnit"/>
                                        <input type="hidden" id="meteringUnitHidden" value="${meter.meteringUnit}" />
                                    </c:when>
                                    <c:otherwise>
                                        <input type="text"   id="meteringUnit"       value="" name="meteringUnit" />
                                        <input type="hidden" id="meteringUnitHidden" value=""/>
                                    </c:otherwise>
                                </c:choose>
                            </td>
                        </tr>
 -->
                        <tr>
                            ...
                            <td class="padding-r20px">
                                <c:choose>
                                    <c:when test="${not empty meter}">
                                        <input class="textBox-width-140" type="text"   id="flowPerUnitPulse"        value="${meter.flowPerUnitPulse}" name="flowPerUnitPulse"/>
                                        <input type="hidden" id="flowPerUnitPulseHidden"  value="${meter.flowPerUnitPulse}" />
                                    </c:when>
                                    <c:otherwise>
                                        <input class="textBox-width-140" type="text"   id="flowPerUnitPulse"        value="" name="flowPerUnitPulse"/>
                                        <input type="hidden" id="flowPerUnitPulseHidden"  value=""/>
                                    </c:otherwise>
                                </c:choose>
                            </td>
                       </tr>
                       <tr>
                            ...
                            <td class="padding-r20px">
                               <c:choose>
                                    <c:when test="${not empty meter}">
                                        <input class="textBox-width-140" type="text"   id="apparatusRoomNumber"       value="${meter.apparatusRoomNumber}" name="apparatusRoomNumber"/>
                                        <input type="hidden" id="apparatusRoomNumberHidden" value="${meter.apparatusRoomNumber}" />
                                    </c:when>
                                    <c:otherwise>
                                        <input class="textBox-width-140" type="text"   id="apparatusRoomNumber"       value="" name="apparatusRoomNumber" />
                                        <input type="hidden" id="apparatusRoomNumberHidden" value=""/>
                                    </c:otherwise>
                                </c:choose>
                            </td>
                        </tr>
        ...
        <div id="btn" class="meter-info-btn2">
            <!-- 버튼이 화면에 보이는 역순으로 작성 -->
            <ul><li><a href="javaScript:updateMeterInstallInfo();" class="on"><fmt:message key="aimir.update"/></a></li></ul>
