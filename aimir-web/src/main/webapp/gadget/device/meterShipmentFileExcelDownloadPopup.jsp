...
<script type="text/javascript" charset="utf-8">
    $(document).ready(function() {
        ...
        $.post('${ctx}/gadget/device/meterShipmentExcelMake.do', 
        		{
    ...
    function getFmtMessage() {
        ...
        fmtMessage[2] = "Type";
        fmtMessage[3] = "EUI ID";
        fmtMessage[4] = "<fmt:message key="aimir.shipment.gs1"/>";
        fmtMessage[5] = "<fmt:message key="aimir.model"/>";
        fmtMessage[6] = "HW Version";
        fmtMessage[7] = "SW Version";
        fmtMessage[8] = "<fmt:message key="aimir.shipment.productiondate"/>";
