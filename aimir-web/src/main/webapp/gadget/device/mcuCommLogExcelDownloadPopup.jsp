...
<head>
    ...
    <script type="text/javascript" charset="utf-8">/*<![CDATA[*/
        ...
        $(document).ready(function(){
            ...
            $.getJSON('${ctx}/gadget/device/getMcuCommLogExportExcel.do',
        ...
        function getExportExcelField() {
            ...
            fieldArray.push("svcTypeCode");
            fieldArray.push("sendBytes");
            fieldArray.push("rcvBytes");
            fieldArray.push("totalBytes");
            fieldArray.push("totalCommTime");
