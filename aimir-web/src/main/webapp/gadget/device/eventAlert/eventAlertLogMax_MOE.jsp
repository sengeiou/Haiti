        ...
        function getEventAlarmLogGrid() {
            ...
            EventAlarmLogGridModel = new Ext.grid.ColumnModel({
                columns: [
                   ...
                   ,{header: headers[1],  dataIndex: 'severity',       tooltip: headers[1], renderer : severityCol}
                   ,{header: headers[2],  dataIndex: 'type',           tooltip: headers[2],  width: colWidth-20}
                   ,{header: headers[11], dataIndex: 'eventAlertName', tooltip: headers[11], width: colWidth+10, align: "left"}
                   ,{header: headers[3],  dataIndex: 'message',        tooltip: headers[3],  width: colWidth+70, align: "left"}
                   ,{header: headers[4],  dataIndex: 'location',       tooltip: headers[4],  width: colWidth-35, align: "left"}
                   ,{header: headers[5],  dataIndex: "activatorId",    tooltip: headers[5],  width: colWidth-5}
                   ,{header: headers[6],  dataIndex: 'activatorType',  tooltip: headers[6],  width: colWidth-5}
                   ,{header: headers[7],  dataIndex: 'status',         tooltip: headers[7],  width: colWidth-21}
                   ,{header: headers[8],  dataIndex: 'openTime',       tooltip: headers[8]}
            ...
            if (EventAlarmLogGridInstanceOn == false) {
                EventAlarmLogGridPanel = new Ext.grid.GridPanel({
        ...
        function getEventAlertLogRealTimeMax() {
            ...
            EventAlertLogRealTimeMaxModel = new Ext.grid.ColumnModel({
                columns: [
                    ...
                    ,{header: fmtMessage[8], dataIndex: 'closeTime',     tooltip: fmtMessage[8], width: colWidth}
                    ,{header: fmtMessage[9], dataIndex: 'duration',      tooltip: fmtMessage[9]}
                ],
                defaults: {
                    sortable: false
                   ,menuDisabled: true
