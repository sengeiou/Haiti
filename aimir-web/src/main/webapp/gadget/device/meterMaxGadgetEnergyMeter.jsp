...
<script type="text/javascript" charset="utf-8">
    ...
    $('#status').change( function () {
		...
		console.log("EmeterType", meterType);
			...
			<div  id="meterInstallInfoEdit" class="w_auto" style="margin-left:165px">
				...
				<table id="meterInstallInfoEditTable" class="wfree">
					...
					<tr>
					 ...
					 <c:choose>
                        <c:when test="${model == 'SM110'}">
                        <tr>
                         <th width="80px"><b><fmt:message key="aimir.meter.command.RelayStatus"/></b></th>
						 <c:choose>
							<c:when test="${not empty switchStatus}">
                        	<td><span class="input-fake">${switchStatus}</span></td>
							</c:when>
							<c:otherwise>
								<td class="padding-r20px"><input type="text"
									class="input-fake" value="-" readonly="readonly">
                    ...
                    <tr>
                        ...
                        <c:choose>
                            <c:when test="${not empty meter.transformerRatio}">
					...
					<tr>
						<th><b><fmt:message key="aimir.energymeter.ct" /></b></th>
						<c:choose>
							<c:when test="${not empty meter.ct}">
								<td><span class="input-fake">${CT}</span></td>
							</c:when>
							<c:otherwise>
								<td class="padding-r20px"><input type="text"
									class="input-fake" value="-" readonly="readonly">
		                ...
		                <div id="meterInstallInfoEdit">
							...
							<tr>
			              	...
			              	<c:choose>
                        		<c:when test="${model == 'SM110'}">
			                    <tr>    
			                       <th><b><fmt:message key="aimir.meter.command.RelayStatus" /></b></th>
			                      	<td>
			                        	<span><input type="text"   id="switchStatus" name="meter.switchStatus" readonly="readonly"  class="border-trans" value="${switchStatus}" /></span>
										<span><input type="hidden" id="switchStatusHidden" value="${switchStatus}" /></span>
									</td>
			                    </tr>
			                </c:when>
			            </c:choose>
                                ...
                                <tr>
                                    ...
                                    <td class="padding-r20px">
                                        <input class="textBox-width-140" type="text" id="tR" name ="transformerRatio" value="${meter.transformerRatio}" onblur="javaScript:getNumberValidCheck(value);"/>
                                    </td>
                                    <th></th>
                                    <td></td>
                                </tr>
			                    <tr>
			                    	<th width="80px"><b><fmt:message key="aimir.energymeter.ct"/></b></th>
									<td class="padding-r20px">
                                        <input class="textBox-width-140" type="text" id="ct" name ="ct" value="${meter.ct}" onblur="javaScript:getNumberValidCheck(value);"/>
									</td>
									<th></th>
									<td></td>
		                        </tr>
