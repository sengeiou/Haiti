...
<head>
    ...
    <script type="text/javascript" charset="utf-8">/*<![CDATA[*/
        ...
        $(document).ready(function(){
            ...
            $.getJSON('${ctx}/gadget/device/getMcuEventAlertLogExportExcel.do',
        ...
        function getExportExcelField() {
            ...
            fieldArray.push("message");
            fieldArray.push("locationName");
            fieldArray.push("openTime");
            fieldArray.push("closeTime");
            fieldArray.push("duration");
