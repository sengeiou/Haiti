    ...
    function commonDateTabButtonInit(){
        ...
        $.getJSON("${ctx}/common/getYear.do"
                ...
                ,function(json) {
                     ...
                     if(tabs.yearly!=0){
                    	   $('#yearlyYearComb_powero').numericOptions({from:startYear,to:endYear,selectedIndex:9});
...
<div id="datetab" class="buttontype" style="display:none">
    ...
    <div id="seasonal">
        ...
        <div id="btn">
            <ul><li style="display:none" id="seasonalSearchLi"><a href="#;" id="seasonalSearch" class="on"><fmt:message key="aimir.button.search" /></a></li></ul>
        </div>
    </div>
    <div id="yearly">
