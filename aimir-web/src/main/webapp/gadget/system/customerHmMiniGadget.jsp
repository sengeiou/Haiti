...
<head>
    ...
    <title><fmt:message key="aimir.customerview"/>(<fmt:message key="aimir.heatmeter"/>)</title>
    ...
    <script type="text/javascript" >/*<![CDATA[*/
        ...
        $(function(){
            flex = getFlexObject('customerMiniChart');
        });
...
<body>
    ...
    <div id="gadget_body">
	    <div id="customerChartDiv">
	        <object id="customerMiniChartEx" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="100%" height="297px">
	            <param name="movie" value="${ctx}/flexapp/swf/customerMiniChart.swf" />
	            <param name="wmode" value="opaque" />
	            <!--[if !IE]>-->
		        <object id="customerMiniChartOt" type="application/x-shockwave-flash" data="${ctx}/flexapp/swf/customerMiniChart.swf" width="100%" height="297px">
		            <param name="wmode" value="opaque" />
		        <!--<![endif]-->
	            <div>
