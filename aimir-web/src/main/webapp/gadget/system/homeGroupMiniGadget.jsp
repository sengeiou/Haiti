    ...
    <script language="JavaScript">/*<![CDATA[*/
        ...
        var getGroupList = function() {
            ...
            groupStore = new Ext.data.JsonStore({
                ...
                root:'result',
                fields: ["groupId", "groupName", "sysId", "groupType", "allUserAccess", "memCount"],
            });
            ...
            groupColModel = new Ext.grid.ColumnModel({
                columns: [
                   ...
                   ,{header: headerDcuSysId, dataIndex: 'sysId', width: colWidth, align: "center", tooltip: headerDcuSysId, renderer: addTooltip}
