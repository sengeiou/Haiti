...
<head>
    ...
    <title><fmt:message key="aimir.customerview"/>(<fmt:message key="aimir.volumecorrector"/>)</title>
    ...
    <script type="text/javascript" >/*<![CDATA[*/
        ...
        var supplierId = "";
        var serviceType = ServiceType.VolumeCorrector;
        var flex;
        ...
        function getFmtMessage(){
            ...
            fmtMessage[cnt++] = "<fmt:message key='aimir.pause'/>";  // 휴지 고객
            fmtMessage[cnt++] = "<fmt:message key='aimir.stop'/>";  // 정지 고객
