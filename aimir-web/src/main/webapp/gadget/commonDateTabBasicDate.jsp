...
<c:if test="${_basicDate == null || _basicDate == ''}">
    <c:set var="_basicDate" value=""/>
</c:if>
<script type="text/javascript" charset="utf-8">/*<![CDATA[*/
    ...
    function commonDateTabInit(){
        ...
        //$("#dailyStartDate")    .datepicker({maxDate:'-1d',showOn: 'button', buttonImage: '${ctx}/themes/images/default/setting/calendar.gif', buttonImageOnly: true, dateFormat:locDateFormat, onSelect: function(dateText, inst) { modifyDate(dateText, inst);}} );
        ...
        $("#hourlyStartDate").datepicker({maxDate:_dpMax,showOn: 'button', buttonImage: '${ctx}/themes/images/default/setting/calendar.gif', buttonImageOnly: true, dateFormat:locDateFormat, onSelect: function(dateText, inst) { modifyDate(dateText, inst);}} );
        $("#hourlyEndDate")  .datepicker({maxDate:_dpMax,showOn: 'button', buttonImage: '${ctx}/themes/images/default/setting/calendar.gif', buttonImageOnly: true, dateFormat:locDateFormat, onSelect: function(dateText, inst) { modifyDate(dateText, inst);}} );
        $("#dailyStartDate") .datepicker({maxDate:_dpMax,showOn: 'button', buttonImage: '${ctx}/themes/images/default/setting/calendar.gif', buttonImageOnly: true, dateFormat:locDateFormat, onSelect: function(dateText, inst) { modifyDate(dateText, inst);}} );
        $("#periodStartDate").datepicker({maxDate:_dpMax,showOn: 'button', buttonImage: '${ctx}/themes/images/default/setting/calendar.gif', buttonImageOnly: true, dateFormat:locDateFormat, onSelect: function(dateText, inst) { modifyDate(dateText, inst);}} );
        $("#periodEndDate")  .datepicker({maxDate:_dpMax,showOn: 'button', buttonImage: '${ctx}/themes/images/default/setting/calendar.gif', buttonImageOnly: true, dateFormat:locDateFormat, onSelect: function(dateText, inst) { modifyDate(dateText, inst);}} );
    ...
    function dailyArrow(bfDate,val,flag){
        ...
        $.getJSON("${ctx}/common/getDate.do"
                ,{searchDate:bfDate,addVal:val, supplierId:_supplierId, basicDate: $("#searchBasicDate").val()}
                ,function(json) {
    ...
    function monthlyArrow(val){
        ...
        $.getJSON("${ctx}/common/getYearMonth.do"
                ,{year:$('#monthlyYearCombo').val(),month:$('#monthlyMonthCombo').val(),addVal:val, basicDate: $("#searchBasicDate").val()}
                ,function(json) {
                	a_year = json.year;
    ...
    function setPeriod(val,flag){
        $.getJSON("${ctx}/common/getDate.do"
                ,{searchDate:'',addVal:val, supplierId:_supplierId, basicDate: $("#searchBasicDate").val()}
                ,function(json) {
    ...
    function getWeekDailyWeekCombo(flag){
        $.getJSON("${ctx}/common/getWeek.do"
                ,{year:$('#weekDailyYearCombo').val(),month:$('#weekDailyMonthCombo').val(),basicDate:$("#searchBasicDate").val()}
                ,function(json) {
    ...
    function getWeekDailyWeekDayCombo(flag){
        ...
        $.getJSON("${ctx}/common/getWeekDay.do"
                ,{year:$('#weekDailyYearCombo').val(),month:$('#weekDailyMonthCombo').val(),
                  week:$('#weekDailyWeekCombo').val(),basicDate:$("#searchBasicDate").val()}
                ,function(json) {
        ...
        if(DateType.HOURLY == _dateType){
            ...
            $.getJSON("${ctx}/common/getWeekPeriod.do"
            		,{year:$('#weeklyYearCombo').val(),month:$('#weeklyMonthCombo').val(),week:$('#weeklyWeekCombo').val(),
                      supplierId:_supplierId, basicDate:$("#searchBasicDate").val()}
                    ,function(json) {
            ...
            $.getJSON("${ctx}/common/getMonthPeriod.do"
                    ,{year:$('#monthlyYearCombo').val(),month:$('#monthlyMonthCombo').val(), supplierId:_supplierId, basicDate:$("#searchBasicDate").val()}
                    ,function(json) {
                        $('#searchStartDate').val(json.startDate);
                        $('#searchEndDate').val(json.endDate);
                        convertSearchDate();
            ...
            $.getJSON("${ctx}/common/getMonthPeriod.do"
                    ,{year:$('#monthlyPeriodEndYearCombo').val(),month:$('#monthlyPeriodEndMonthCombo').val(),
                      upplierId:_supplierId, basicDate:$("#searchBasicDate").val()}
                    ,function(json) {
                        $('#searchEndDate').val(json.endDate);
                        convertSearchDate();
                    });
            ...
            $.getJSON("${ctx}/common/getWeekDayPeriod.do"
                    ,{year:$('#weekDailyYearCombo').val(),month:$('#weekDailyMonthCombo').val(),
                      week:$('#weekDailyWeekCombo').val(),weekDay:$('#weekDailyWeekDayCombo').val(),
                      supplierId:_supplierId, basicDate:$("#searchBasicDate").val()}
                    ,function(json) {
                        $('#searchStartDate').val(json.startDate);
                        $('#searchEndDate').val(json.endDate);
            ...
            $.getJSON("${ctx}/common/getYearPeriod.do"
                    ,{year:$('#yearlyYearCombo').val(), supplierId:_supplierId, basicDate: $("#searchBasicDate").val()}
                    ,function(json) {
                        $('#searchStartDate').val(json.startDate);
                        $('#searchEndDate').val(json.endDate);
                        convertSearchDate();
...
<div id="datetab" style="display:none">
    ...
    <div id="yearly">
        ...
        <input id="searchBasicDate" type="hidden" value="${_basicDate}"/>
