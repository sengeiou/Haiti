...
//      condArray[3] = $('#searchEndHour').val();
    ...
    function getCycleTypeList() {
        ...
        $("#dateTypeList option:eq(0)").replaceWith("<option value=1>일</option>");
        if(supplierId == ""){
            $("#dateTypeList").val(0);
        }else{
	            ...
	            <ul class="valueMargin2">
	                <li>
		                <form id="myForm" >
		                    ...
		                    <span class="black2 left"><input id="savingGoalTarget" name="savingGoalTarget" type="text" class="value" size="4" maxlength="4">%&nbsp;</span>
		                    <span class="black left"><fmt:message key='aimir.energy.economical.target'/></span>
