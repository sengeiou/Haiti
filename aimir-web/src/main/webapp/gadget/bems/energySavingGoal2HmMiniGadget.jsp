...
<script type="text/javascript" charset="utf-8">
    ...
    // 에너지 타입 ( 전기Em : 0 , 가스Gm : 1 , 수도Wm : 2 열량Hm : 3)
    var myEnergyType = "3";
    var myEnergyTypeStr = "Hm";
    ...
    function getEnergySavingGoal2Info(){
    	...
    	var energyType = myEnergyType; // energyType : 에너지 타입 ( 전기 : 0 , 가스 : 1 , 수도 : 2  열량 : 3)
    	var requestType='';
    ...
    */
    ...
    function putParams(){  
        ...
        condArray[6] = myEnergyType; // energyType : 에너지 타입 ( 전기 : 0 , 가스 : 1 , 수도 : 2 열량 : 3 )
	            ...
	            <ul class="valueMargin2">
	                <li>
		                <form id="myForm">
		                    ...
		                    <span id="avgComment" class="left">&nbsp;&nbsp;0<fmt:message key='aimir.years'/> 0<fmt:message key='aimir.month'/>&nbsp;&nbsp;<fmt:message key='aimir.avgContrast'/></span>
		                    <span class="left"><input id="savingGoalTarget" name="savingGoalTarget" type="text" class="value" size="4" maxlength="3">%&nbsp;&nbsp;</span>
