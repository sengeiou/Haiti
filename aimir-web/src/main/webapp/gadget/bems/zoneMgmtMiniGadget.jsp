...
<div id="wrapper"> 
    <div id="container">
        <!-- 탐색기 및 사용량 테이블 (S) -->
                    ...
                    <!-- 탐색기 및 사용량 테이블 (S) -->
        <div class="Bchart">
            <object id="ZoneMgmtMiniEx" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="100%" height="300" codebase="http://fpdownload.macromedia.com/get/flashplayr/current/swflash.cab">
                <param name="movie" value="${ctx}/flexapp/swf/bems/zoneMgmtMini.swf">
                ...
                <!--[if !IE]>-->
                <object id="ZoneMgmtMiniOt" type="application/x-shockwave-flash" data="${ctx}/flexapp/swf/bems/zoneMgmtMini.swf" width="100%" height="300">
                  <!--<![endif]-->
                  <param name="quality" value="high">
                  <param name="wmode" value="opaque">
                  <param name="swfversion" value="9.0.45.0">
