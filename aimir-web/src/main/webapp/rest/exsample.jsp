...
<title>Hibernate</title>
    ...
    <link rel="stylesheet" type="text/css" href="${ctx}/scripts/ext/resources/css/ext-debug-all.css" />
    <link rel="stylesheet" type="text/css" href="${ctx}/scripts/ext/exsamples/ux/css/CenterLayout.css" />
    <link rel="stylesheet" type="text/css" href="${ctx}/scripts/ext/exsamples/layout-browser/layout-browser.css" />
    ...
    <script type="text/javascript" src="${ctx}/scripts/ext/exsamples/ux/CenterLayout.js"></script>
    <script type="text/javascript" src="${ctx}/scripts/ext/exsamples/ux/RowLayout.js"></script>
    <script type="text/javascript" src="${ctx}/scripts/ext/exsamples/layout-browser/layouts/basic.js"></script>
    <script type="text/javascript" src="${ctx}/scripts/ext/exsamples/layout-browser/layouts/custom.js"></script>
    <script type="text/javascript" src="${ctx}/scripts/ext/exsamples/layout-browser/layouts/combination.js"></script>
    <script type="text/javascript" src="${ctx}/scripts/ext/exsamples/layout-browser/layout-browser.js"></script>
<script>
...
<body>
	<div id=restGet><b>REST Get</b>
		<form name=restGet>
			<input type=text name=id />
			<input type=hidden name=action value=deviceVendor.html />
			<input type=button value=Submit onclick=javascript:doAjaxTestGet(this.form); />
		</form>
	</div>
	<div id=result>1</div>
	<div id=restPost><b>REST Post</b>
		<form name=restPost action=deviceForm.html method=post >
    ...
    <div style="display:none;">
        ...
        <!-- Start page content -->
        <div id="start-div">
            <div style="float:left;" ><img src="${ctx}/scripts/ext/exsamples/layout-browser/images/layout-icon.gif" /></div>
