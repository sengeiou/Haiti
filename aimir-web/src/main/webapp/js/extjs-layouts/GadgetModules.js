...
Ext.namespace("Ext.gadget");

Ext.gadget.MainPanel = Ext.extend(Ext.Panel, {
	id:'main-panel'
	//id:'main-panel', 가로사이즈 계산  및 스크롤 문제로 주석처리 : ext-all.css(line #6473 에서 스크롤 컨트롤 되도록 변경되었음) : KJPARK
	//boxMinWidth:1200,
	//autoScroll:true
});
Ext.gadget.HeaderPanel = Ext.extend(Ext.Panel, {
	region: 'north',
	id:'header-panel',
	height: 49
});

// Common Gadget TabPanel
Ext.gadget.TabPanel = Ext.extend(Ext.TabPanel, {
	deferredRender:true,
	tabPosition:'top',
	activeTab: 0 ,
	border:false
