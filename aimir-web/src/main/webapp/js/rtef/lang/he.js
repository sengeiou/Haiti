...
// Dropdowns
// Format Dropdown
var lblFormat			= "<option value=\"\" selected=\"selected\">סגנון</option>";
...
// Font Dropdown
var lblFont				= "<option value=\"\" selected=\"selected\">גופן</option>";
...
// Paste As Plain Text
var lblPasteTextHint	= "עצה: כדי להדביק, אפשר להקליק כפתור-ימני ולבחור  \"הדבק\" או להשתמש ב-  Ctrl-V.";
var lblPasteTextVal0	= "אנא הכנס טקסט."
var lblPasteTextSubmit	= "אישור";
var lblPasteTextCancel	= "ביטול";
// Paste from Word
var lblPasteWordHint	= "עצה: כדי להדביק, אפשר להקליק כפתור-ימני ולבחור  \"הדבק\" או להשתמש ב-  Ctrl-V.";
