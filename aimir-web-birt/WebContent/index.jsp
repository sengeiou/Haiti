...
<HTML>
	...
	<script>
function report(){
	var opts="dialogWidth:1080px; dialogHeight:768px;resizable:no;status:no;help:no;status:no;"
	       window.showModalDialog("/birt-viewer/frameset?__report=test.rptdesign", "", opts)
}
	</script>
	</HEAD>
	<BODY>
			...
			<TBODY>
				<TR>
					<TD class=content style="PADDING-RIGHT: 10px; PADDING-LEFT: 10px; PADDING-BOTTOM: 10px; PADDING-TOP: 10px" >
						...
						<p><a href="javascript:report();">View Example</a>
