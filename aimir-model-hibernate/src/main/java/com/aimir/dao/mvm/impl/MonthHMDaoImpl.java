...
public class MonthHMDaoImpl extends AbstractHibernateGenericDao<MonthHM, Integer> implements MonthHMDao {

	private static Log logger = LogFactory.getLog(MonthHMDaoImpl.class);
    
	@Autowired
	protected MonthHMDaoImpl(SessionFactory sessionFactory) {
		super(MonthHM.class);
	...
	public List<Object> getMonthHMsMaxMinAvgSum(Set<Condition> conditions, String div) {
		...
		Criteria criteria = getSession().createCriteria(MonthHM.class);
    ...
    public List<Object> getMonthHMsCount(Set<Condition> conditions,
            String div) {

        
        DetachedCriteria  criteriaSub = DetachedCriteria.forClass(MonthHM.class);
        Criteria criteria = getSession().createCriteria(MonthHM.class);
	 ...
	 */
	@SuppressWarnings("unchecked")
    public List<Object> getConsumptionHmCo2MonthSearchDayTypeTotal(Map<String, Object> condition) {
		...
		sb.append("\n 	SELECT LL.SUPPLIER_ID , SUM(D.TOTAL) TOTAL FROM MONTH_HM D , ( ");
		...
		sb.append("\n LEFT JOIN ");
		sb.append("\n (  ");
		sb.append("\n 	SELECT LL2.SUPPLIER_ID , SUM(D2.TOTAL) AS CO2_TOTAL FROM MONTH_HM D2 , ( ");
	...
	/**
	 * BEMS 동별 월단위 열량사용량 , 탄소배출량 차트 데이터 조회.
    ...
    public List<Object> getConsumptionHmCo2MonthMonitoringLocationId(Map<String, Object> condition) {
		...
		logger.info("BEMS 동별   월단위 열량사용량 , 탄소배출량  차트 데이터 조회.\n==== conditions ====\n" + condition);
		...
		sb.append("\n 	SELECT LL.ID AS LOCATION_ID , LL.NAME , LL.MDS_ID , D.CHANNEL , SUM(D.TOTAL) TOTAL FROM MONTH_HM D , ( ");
		...
		sb.append("\n LEFT JOIN ");
		sb.append("\n (  ");
		sb.append("\n 	SELECT LL2.ID AS LOCATION_ID , SUM(D2.TOTAL) AS CO2_TOTAL FROM MONTH_HM D2 , ( ");
    ...
    public List<Object> getConsumptionHmCo2MonthMonitoringParentId(
		...
		logger
				.info("BEMS 동별   월단위 열량사용량 , 탄소배출량  차트 데이터 조회.\n==== conditions ====\n"
						+ condition);
    ...
    public List<Object> getConsumptionHmCo2MonitoringLocationId(Map<String, Object> condition) {
		...
		sb.append("\n SELECT HM.YYYYMM AS YYYYMM , HM.TOTAL AS HM_TOTAL ,  CO2.TOTAL AS CO2_TOTAL  FROM (  ");
    ...
    public MonthHM getMonthHM(Map<String,Object> params){
		...
		List<MonthHM> list = criteria.list();
	...
	public List<Object> getEnergySavingReportMonthlyData(String[] years, int channel, Integer[] meterIds) {
		...
		StringBuffer sb = new StringBuffer();
		sb.append("select SUBSTR(yyyymm, 5, 2) as MM, sum(total) as TOTAL from month_hm ")
	...
	public List<Object> getConsumptionHmValueSum(int supplierId ,String startDate, String endDate, int startday, int endday) {
