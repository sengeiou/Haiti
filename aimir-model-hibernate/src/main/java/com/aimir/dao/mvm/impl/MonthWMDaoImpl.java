...
public class MonthWMDaoImpl extends AbstractHibernateGenericDao<MonthWM, Integer> implements MonthWMDao {

    Log logger = LogFactory.getLog(MonthWMDaoImpl.class);
    
	@Autowired
	protected MonthWMDaoImpl(SessionFactory sessionFactory) {
		super(MonthWM.class);
	...
	public List<Object> getMonthWMsMaxMinAvgSum(Set<Condition> conditions, String div) {
		...
		Criteria criteria = getSession().createCriteria(MonthWM.class);
    ...
    public List<Object> getMonthWMsCount(Set<Condition> conditions,
            String div) {

        
        DetachedCriteria  criteriaSub = DetachedCriteria.forClass(MonthWM.class);
        Criteria criteria = getSession().createCriteria(MonthWM.class);
	 ...
	 */
	@SuppressWarnings("unchecked")
    public List<Object> getConsumptionWmCo2MonthSearchDayTypeTotal(Map<String, Object> condition) {
		...
		sb.append("\n 	SELECT LL.SUPPLIER_ID , SUM(D.TOTAL) TOTAL FROM MONTH_WM D , ( ");
...
//		sb.append("\n 		   	) ");
		...
		sb.append("\n LEFT JOIN ");
		sb.append("\n (  ");
		sb.append("\n 	SELECT LL2.SUPPLIER_ID , SUM(D2.TOTAL) AS CO2_TOTAL FROM MONTH_WM D2 , ( ");
...
//		sb.append("\n 		   	) ");
	...
	/**
	 * BEMS 동별 월단위 수도사용량 , 탄소배출량 차트 데이터 조회.
    ...
    public List<Object> getConsumptionWmCo2MonthMonitoringLocationId(Map<String, Object> condition) {
		...
		logger.info("BEMS 동별   월단위 수도사용량 , 탄소배출량  차트 데이터 조회.\n==== conditions ====\n" + condition);
		...
		sb.append("\n 	SELECT LL.ID AS LOCATION_ID , LL.NAME , LL.MDS_ID , D.CHANNEL , SUM(D.TOTAL) TOTAL FROM MONTH_WM D , ( ");
...
//		sb.append("\n 		   	) ");
		...
		sb.append("\n LEFT JOIN ");
		sb.append("\n (  ");
		sb.append("\n 	SELECT LL2.ID AS LOCATION_ID , SUM(D2.TOTAL) AS CO2_TOTAL FROM MONTH_WM D2 , ( ");
...
//		sb.append("\n 		   	) ");
    ...
    public List<Object> getConsumptionWmCo2MonthMonitoringParentId(Map<String, Object> condition) {
		...
		Integer channel = (Integer)condition.get("channel");
		@SuppressWarnings("unused")
        String channelType = (String) condition.get("channelType");
		String meterType = (String) condition.get("meterType");// 탄소일 경우만 0 , 수도/온도/습도의  사용량일때는 1
    ...
    public List<Object> getConsumptionWmCo2MonitoringLocationId(Map<String, Object> condition) {
		...
		sb.append("\n SELECT WM.YYYYMM AS YYYYMM , WM.TOTAL AS WM_TOTAL ,  CO2.TOTAL AS CO2_TOTAL  FROM (  ");
...
//		sb.append("\n 		   	) ");
	...
	public MonthWM getMonthWM(Map<String,Object> params){
		...
		criteria.add(Restrictions.eq("contract.customer.supplierId",supplierId));
		
		List<MonthWM> list = criteria.list();
	...
	public List<Object> getEnergySavingReportMonthlyData(String[] years, int channel, Integer[] meterIds) {
		...
		StringBuffer sb = new StringBuffer();
		sb.append("select SUBSTR(yyyymm, 5, 2) as MM, sum(total) as TOTAL from month_wm ")
	...
	public List<Object> getConsumptionWmValueSum(int supplierId, String startDate, String endDate, int startday, int endday) {
