package com.aimir.service.system.impl.loadControlMgmt;
...
@Service(value="LoadControlMgmtManager")
@Transactional(readOnly=false)
public class LoadControlMgmtManagerImpl implements LoadControlMgmtManager {
...
//			System.out.println("Authenticating");
	...
	public List<Map<String, Object>> getLoadControlHistory(String userId, String contractNumber, int page, int limit, String fromDate, String toDate) {
		return demandResponseEventLogDao.getDemandResponseHistory(userId, contractNumber, page, limit, fromDate, toDate);
	}

	public String getLoadControlHistoryTotalCount(String userId, String contractNumber, String fromDate, String toDate) {
