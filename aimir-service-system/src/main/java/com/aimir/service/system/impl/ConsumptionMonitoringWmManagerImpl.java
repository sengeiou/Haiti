...
@WebService(endpointInterface = "com.aimir.service.system.ConsumptionMonitoringWmManager")
@Service(value = "consumptionMonitoringWmManager")
public class ConsumptionMonitoringWmManagerImpl implements
		ConsumptionMonitoringWmManager {

	Log logger = LogFactory.getLog(ConsumptionMonitoringWmManagerImpl.class);
    ...
    public Map<String, Object> getTotalUseOfSearchType(
		...
		try {
			...
			conditionDay.put("meterType", CommonConstants.MeterType.WaterMeter
					.getMonthTableName());
			...
			conditionWeek.put("meterType", CommonConstants.MeterType.WaterMeter
					.getMonthTableName());
			String weekday = "";
			...
			conditionMonth.put("meterType",
					CommonConstants.MeterType.WaterMeter.getMonthTableName());
			...
			conditionYear.put("meterType", CommonConstants.MeterType.WaterMeter
					.getMonthTableName());
			...
			if (CommonConstants.DateType.DAILY.getCode().equals(searchDateType)) {
				...
				returnEnergyGrid = monthWMDao
						.getConsumptionWmCo2MonthSearchDayTypeTotal2(conditionDay);
				conditionDay.put("channel", DefaultChannel.Co2.getCode());
				returnCo2Grid = monthWMDao
						.getConsumptionWmCo2MonthSearchDayTypeTotal2(conditionDay);
				...
				if (!startWday.equals(endWday)) {
					returnEnergyGrid = monthWMDao
							.getConsumptionWmCo2MonthSearchDayTypeTotal2(conditionWeek);

					returnEnergyGrid2 = monthWMDao
							.getConsumptionWmCo2MonthSearchDayTypeTotal2(conditionWeek);
					conditionWeek.put("channel", DefaultChannel.Co2.getCode());

					returnCo2Grid = monthWMDao
							.getConsumptionWmCo2MonthSearchDayTypeTotal2(conditionWeek);
					returnCo2Grid2 = monthWMDao
							.getConsumptionWmCo2MonthSearchDayTypeTotal2(conditionWeek);
				...
				// 월
				returnEnergyGrid = monthWMDao
						.getConsumptionWmCo2MonthSearchDayTypeTotal2(conditionMonth);

				conditionMonth.put("channel", DefaultChannel.Co2.getCode());
				returnCo2Grid = monthWMDao
						.getConsumptionWmCo2MonthSearchDayTypeTotal2(conditionMonth);
				System.out.println("returnCo2Grid:::" + returnCo2Grid);
				if (yearAverageUsage > 0) {
				...
				// 분기
				returnEnergyGrid = monthWMDao
						.getConsumptionWmCo2MonthSearchDayTypeTotal2(conditionYear);
	...
	public Map<String, Object> getRootLocationId(Map<String, Object> condition) {
		...
		try {
			...
			returnLocation = dayWmDao.getRootLocationId(condition1);
	...
	/*
	 * 빌딩(동/층) 수도 사용량 Max 페이지
	 */
	@SuppressWarnings({ "unchecked", "unused", "rawtypes" })
	public Map<String, Object> getBuildingLookUpMaxWm(
		...
		// 수도사용량/탄소배출량
		List<HashMap<String, Object>> returnWmCo2LocationDay = new ArrayList<HashMap<String, Object>>();
		List<HashMap<String, Object>> returnWmCo2LocationDayInfo = new ArrayList<HashMap<String, Object>>();
		List<HashMap<String, Object>> returnWmCo2LocationWeek = new ArrayList<HashMap<String, Object>>();
		List<HashMap<String, Object>> returnWmCo2LocationWeekInfo = new ArrayList<HashMap<String, Object>>();
		List<HashMap<String, Object>> returnWmCo2LocationMonth = new ArrayList<HashMap<String, Object>>();
		List<HashMap<String, Object>> returnWmCo2LocationMonthInfo = new ArrayList<HashMap<String, Object>>();
		List<HashMap<String, Object>> returnWmCo2LocationQuarter = new ArrayList<HashMap<String, Object>>();
		List<HashMap<String, Object>> returnWmCo2LocationQuarterInfo = new ArrayList<HashMap<String, Object>>();
		...
		try {
			...
			conditionDayLocation.put("meterType",
					CommonConstants.MeterType.WaterMeter.getDayTableName());
			...
			returnEnergyGrid = dayWmDao
					.getConsumptionWmCo2DayMonitoringParentId(conditionDayLocation);
			conditionDayLocation.put("channel", DefaultChannel.Co2.getCode());
			returnCo2Grid = dayWmDao
					.getConsumptionWmCo2DayMonitoringParentId(conditionDayLocation);
			// 2. 주기별 사용량 조회
			// 일(시간)
			returnWmCo2LocationDay = wmCo2MonitoringSumMinMaxDay(conditionDay);
			returnWmCo2LocationDayInfo = wmCo2MonitoringSumMinMaxDayInfo(conditionDay);
			// 주
			returnWmCo2LocationWeek = wmCo2MonitoringSumMinMaxWeek(conditionWeek);
			returnWmCo2LocationWeekInfo = wmCo2MonitoringSumMinMaxWeekInfo(conditionWeek);
			// 월
			returnWmCo2LocationMonth = wmCo2MonitoringSumMinMaxMonth(conditionMonth);
			returnWmCo2LocationMonthInfo = wmCo2MonitoringSumMinMaxMonthInfo(conditionMonth);
			// 분기
			returnWmCo2LocationQuarter = wmCo2MonitoringSumMinMaxQuarter(conditionYear);
			returnWmCo2LocationQuarterInfo = wmCo2MonitoringSumMinMaxQuarterInfo(conditionYear);
		...
		result.put("myChartDataLocation", retGrid); // 동별 수도/탄소 값의 합.
		result.put("myChartDataDay", returnWmCo2LocationDay);
		result.put("myChartDataDayInfo", returnWmCo2LocationDayInfo);
		result.put("myChartDataWeek", returnWmCo2LocationWeek);
		result.put("myChartDataWeekInfo", returnWmCo2LocationWeekInfo);
		result.put("myChartDataMonth", returnWmCo2LocationMonth);
		result.put("myChartDataMonthInfo", returnWmCo2LocationMonthInfo);
		result.put("myChartDataQuarter", returnWmCo2LocationQuarter);
		result.put("myChartDataQuarterInfo", returnWmCo2LocationQuarterInfo);
	...
	/*
	 * 빌딩(동/층) 수도 사용량 Min 페이지
	 */
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public Map<String, Object> getBuildingLookUpWm(Map<String, Object> condition) {
		...
		// 수도사용량/탄소배출량
		List<HashMap<String, Object>> returnWmCo2LocationSumGrid = new ArrayList<HashMap<String, Object>>();
		...
		try {
			...
			Calendar monthCalendar = Calendar.getInstance();
			System.out
					.println("##############################2010.07.07일 셋팅! TEST 가 끝나면 지울것!![getBuildingLookUpWm]");
			...
			// conditionMonth.put("locationId" , locationId);
			// c.set(c.get(Calendar.YEAR) , 0 , 1);
			monthCalendar.set(c.get(Calendar.YEAR), 0, 1);
			conditionMonth.put("startDate", formatter1.format(monthCalendar
					.getTime()));
			// c.set(c.get(Calendar.YEAR) , 11 ,
			// c.getActualMaximum(Calendar.DAY_OF_MONTH));
			monthCalendar.set(c.get(Calendar.YEAR), 11, c
					.getActualMaximum(Calendar.DAY_OF_MONTH));
			conditionMonth.put("endDate", formatter1.format(monthCalendar
					.getTime()));
			// conditionMonth.put("channel" ,
			// formatter1.format(monthCalendar.getTime()));
			conditionMonth.put("channel", DefaultChannel.Usage.getCode());
			conditionMonth.put("meterType",
					CommonConstants.MeterType.WaterMeter.getMonthTableName());
			...
			if (CommonConstants.DateType.DAILY.getCode().equals(searchDateType)) {
				...
				returnEnergyGrid = dayWmDao
						.getConsumptionWmCo2DayMonitoringParentId(conditionDay);
				conditionDay.put("channel", DefaultChannel.Co2.getCode());
				returnCo2Grid = dayWmDao
						.getConsumptionWmCo2DayMonitoringParentId(conditionDay);
			} else if (CommonConstants.DateType.WEEKLY.getCode().equals(
				...
				returnEnergyGrid = dayWmDao
						.getConsumptionWmCo2DayMonitoringParentId(conditionWeek);
				conditionWeek.put("channel", DefaultChannel.Co2.getCode());
				returnCo2Grid = dayWmDao
						.getConsumptionWmCo2DayMonitoringParentId(conditionWeek);
				...
				returnEnergyGrid = monthWMDao
						.getConsumptionWmCo2MonthMonitoringParentId(conditionMonth);
				conditionMonth.put("channel", DefaultChannel.Co2.getCode());
				returnCo2Grid = monthWMDao
						.getConsumptionWmCo2MonthMonitoringParentId(conditionMonth);
			} else if (CommonConstants.DateType.QUARTERLY.getCode().equals(
				...
				returnEnergyGrid = monthWMDao
						.getConsumptionWmCo2MonthMonitoringParentId(conditionYear);
				conditionYear.put("channel", DefaultChannel.Co2.getCode());
				returnCo2Grid = monthWMDao
						.getConsumptionWmCo2MonthMonitoringParentId(conditionYear);
			} else {
			...
			if (CommonConstants.DateType.DAILY.getCode().equals(searchDateType)) {
				...
				// 빌딩 전체 수도사용량/탄솝출량 의 최대 ,최소,합
				returnWmCo2LocationSumGrid = wmCo2MonitoringSumMinMaxDay(conditionDay);
				...
				// 빌딩 전체 수도사용량/탄솝출량 의 최대 ,최소,합
				returnWmCo2LocationSumGrid = wmCo2MonitoringSumMinMaxWeek(conditionWeek);
				...
				// 빌딩 전체 수도사용량/탄솝출량 의 최대 ,최소,합
				returnWmCo2LocationSumGrid = wmCo2MonitoringSumMinMaxMonth(conditionMonth);
				...
				// 빌딩 전체 수도사용량/탄솝출량 의 최대 ,최소,합
				returnWmCo2LocationSumGrid = wmCo2MonitoringSumMinMaxQuarter(conditionYear);
		...
		// System.out.println("returnGrid%%%%%%%%%%%%:"+returnGrid);
		List<Object> retGrid = new ArrayList<Object>();
		Map<String, Object> map = new HashMap<String, Object>();
		for (int i = 0; i < returnEnergyGrid.size(); i++) {
			Map<String, Object> tmp = (Map<String, Object>) returnEnergyGrid
		...
		result.put("grid", retGrid); // 동별 수도/탄소 값의 합.
		result.put("sumGrid", returnWmCo2LocationSumGrid); // 빌딩 전체 수도사용량/탄솝출량 의
		// 최대값 ,최소값,합
		result.put("sumTHGrid", returnTmHmLocationSumGrid); // 빌딩 전체 수도온도량/습도량 의
		// 합
		result.put("returnLocation", returnLocation); // 동정보
    ...
    private void mapSum(Map<String, Object> map1, Map<String, Object> map2) {
		...
		Double co2total1 = DecimalUtil.ConvertNumberToDouble(map1.get("CO2_TOTAL"));

		Double total2 = DecimalUtil.ConvertNumberToDouble(map2.get("TOTAL"));
		Double co2total2 = DecimalUtil.ConvertNumberToDouble(map2.get("CO2_TOTAL"));

		map1.put("TOTAL", total1 + total2);
		map1.put("CO2_TOTAL", co2total1 + co2total2);
	}
	...
	/**
	 * 일(시간) 빌딩 전체 : 수도사용량/탄솝출량 사용량 정보 금일 일사용량 , 평균요금 , 최소사용량 , 최대사용량
	 * 
	 * @param condition
	 * @return
	 */
	@SuppressWarnings({ "unused", "unchecked" })
    private List<HashMap<String, Object>> wmCo2MonitoringSumMinMaxDayInfo(
			Map<String, Object> condition) {
		...
		List<Object> returnWmCo2LocationSumGridTemp = new ArrayList<Object>();
		 ...
		 */
		returnWmCo2LocationSumGridTemp = dayWmDao
				.getConsumptionWmCo2MonitoringSumMinMaxLocationId(conditionDayInfo);
		if (returnWmCo2LocationSumGridTemp.isEmpty()) {
			Set<Location> childrenLocationSet = locationDao.get(locationId)
					.getChildren();

			if (childrenLocationSet != null && !childrenLocationSet.isEmpty()) {
				returnWmCo2LocationSumGridTemp = dayWmDao
						.getConsumptionWmCo2MonitoringSumMinMaxPrentId(conditionDayInfo);
			}
		}
		/*************************/
		...
		if (!returnWmCo2LocationSumGridTemp.isEmpty()) {
			...
			for (int i = 0; i < returnWmCo2LocationSumGridTemp.size(); i++) {

				HashMap<String, Object> temp = (HashMap<String, Object>) returnWmCo2LocationSumGridTemp
						.get(i);
				...
				for (int k = 0; k < 24; k++) {
					...
					double check = Double.valueOf(ObjectUtils.defaultIfNull(
							temp.get("WM_SUM_" + setTime), "0").toString());
				...
				double totalValue = DecimalUtil.ConvertNumberToDouble(temp.get("WM_TOTAL"));
	...
	/**
	 * 일(시간) 빌딩 전체 : 수도사용량/탄솝출량 의 최대 ,최소,합 금일 / 전일 데이터 조회
	 * 
	 * @param condition
	 * @return
	 */
	@SuppressWarnings({ "unused", "unchecked" })
    private List<HashMap<String, Object>> wmCo2MonitoringSumMinMaxDay(Map<String, Object> condition) {
		...
		List<Object> returnWmCo2LocationSumGridTemp = new ArrayList<Object>();
		List<Object> returnWmCo2LocationSumGridTempOld = new ArrayList<Object>();
		...
		if (!parent.isEmpty()) {
			returnWmCo2LocationSumGridTemp = dayWmDao
					.getConsumptionWmCo2MonitoringSumMinMaxLocationId(conditionDay);
			returnWmCo2LocationSumGridTempOld = dayWmDao
					.getConsumptionWmCo2MonitoringSumMinMaxLocationId(conditionOldDay);
		}
		if (returnWmCo2LocationSumGridTemp.isEmpty()) {
			Set<Location> childrenLocationSet = locationDao.get(locationId)
					.getChildren();
			...
			if (childrenLocationSet != null && !childrenLocationSet.isEmpty()) {
				returnWmCo2LocationSumGridTemp = dayWmDao
						.getConsumptionWmCo2MonitoringSumMinMaxPrentId(conditionDay);
				returnWmCo2LocationSumGridTempOld = dayWmDao
						.getConsumptionWmCo2MonitoringSumMinMaxPrentId(conditionOldDay);
			}
		}
		/*************************/
		...
		if (!returnWmCo2LocationSumGridTemp.isEmpty()) {
			for (int i = 0; i < returnWmCo2LocationSumGridTemp.size(); i++) {
				...
				if (!returnWmCo2LocationSumGridTempOld.isEmpty()) {

					temp2 = (HashMap<String, Object>) returnWmCo2LocationSumGridTempOld
							.get(i);
				}
				for (int k = 0; k < 24; k++) {
					String setTime = StringUtils.leftPad(String.valueOf(k), 2,
					...
					setTemp.put("WMMIN", temp.get("WM_MIN_" + setTime));
					setTemp.put("WMMAX", temp.get("WM_MAX_" + setTime));
					setTemp.put("WMSUM", temp.get("WM_SUM_" + setTime));
					...
					if (!temp2.isEmpty()) {
						...
						setTemp.put("OLDWMMIN", temp2.get("WM_MIN_" + setTime));
						setTemp.put("OLDWMMAX", temp2.get("WM_MAX_" + setTime));
						setTemp.put("OLDWMSUM", temp2.get("WM_SUM_" + setTime));
						...
						setTemp.put("OLDWMMIN", null);
						setTemp.put("OLDWMMAX", null);
						setTemp.put("OLDWMSUM", null);
            ...
            for (int k = 0; k < 24; k++) {
                ...
                setTemp.put("OLDWMMIN", 0);
                setTemp.put("OLDWMMAX", 0);
                setTemp.put("OLDWMSUM", 0);
	...
	/**
	 * 일주일 : 빌딩 전체 수도사용량/탄솝출량 의 합 기본정보 금주 주간 사용량 합 , 평균사용요금 , 최소사용량 , 최대사용량.
	 * 
	 * @param condition
	 * @return
	 */
	@SuppressWarnings("unchecked")
    private List<HashMap<String, Object>> wmCo2MonitoringSumMinMaxWeekInfo(
			Map<String, Object> condition) {
		 ...
		 */
		returnWmCo2LocationSumGridTemp = dayWmDao
				.getConsumptionWmCo2WeekMonitoringLocationId(conditionWeek);
		if (returnWmCo2LocationSumGridTemp.isEmpty()) {
			Set<Location> childrenLocationSet = locationDao.get(locationId)
					.getChildren();
			...
			if (childrenLocationSet != null && !childrenLocationSet.isEmpty()) {
				returnWmCo2LocationSumGridTemp = dayWmDao
						.getConsumptionWmCo2WeekMonitoringParentId(conditionWeek);
			}
		}
		/*************************/
		...
		if (!returnWmCo2LocationSumGridTemp.isEmpty()) {
			...
			for (int i = 0; i < 7; i++) {
				...
				for (int j = 0; j < returnWmCo2LocationSumGridTemp.size(); j++) {
					temp = (HashMap<String, Object>) returnWmCo2LocationSumGridTemp
							.get(j);
				...
				chargeMap.put("serviceType",
						MeterType.WaterMeter.getServiceType());
				chargeMap.put("dateType", DateType.DAILY.getCode());
				chargeMap.put("usage", check);
				...
				avgCharge = sumCharge / returnWmCo2LocationSumGridTemp.size();
	...
	/**
	 * 일주일 : 빌딩 전체 수도사용량/탄솝출량 의 합 금주 / 전주 데이터 조회
	 * 
	 * @param condition
	 * @return
	 */
	@SuppressWarnings("unchecked")
    private List<HashMap<String, Object>> wmCo2MonitoringSumMinMaxWeek(Map<String, Object> condition) {
		...
		// List<Object> returnWmCo2LocationSumGridTemp =
		// dayWmDao.getConsumptionWmCo2WeekMonitoring( condition );
		// List<Object> returnWmCo2LocationSumGridWeekTemp =
		// dayWmDao.getConsumptionWmCo2WeekMonitoring( conditionOldWeek );
		List<Object> returnWmCo2LocationSumGridWeekTemp = new ArrayList<Object>();
		List<Object> returnWmCo2LocationSumGridWeekOldTemp = new ArrayList<Object>();
		...
		if (!parent.isEmpty()) {
			returnWmCo2LocationSumGridWeekTemp = dayWmDao
					.getConsumptionWmCo2WeekMonitoringLocationId(conditionWeek);
			returnWmCo2LocationSumGridWeekOldTemp = dayWmDao
					.getConsumptionWmCo2WeekMonitoringLocationId(conditionOldWeek);
		}

		if (returnWmCo2LocationSumGridWeekTemp.isEmpty()) {
			Set<Location> childrenLocationSet = locationDao.get(locationId)
					.getChildren();
			...
			if (childrenLocationSet != null && !childrenLocationSet.isEmpty()) {
				returnWmCo2LocationSumGridWeekTemp = dayWmDao
						.getConsumptionWmCo2WeekMonitoringParentId(conditionWeek);
				returnWmCo2LocationSumGridWeekOldTemp = dayWmDao
						.getConsumptionWmCo2WeekMonitoringParentId(conditionOldWeek);
			}
		}
		/*************************/
		...
		if (!returnWmCo2LocationSumGridWeekTemp.isEmpty()) {
            ...
            for(int i =0 ; i<7 ; i++){
				...
				for (int j = 0; j < returnWmCo2LocationSumGridWeekTemp.size(); j++) {
					temp = (HashMap<String, Object>) returnWmCo2LocationSumGridWeekTemp
							.get(j);
				...
				temp = (HashMap<String, Object>) returnWmCo2LocationSumGridWeekTemp
						.get(k);
				if (!returnWmCo2LocationSumGridWeekOldTemp.isEmpty()
						&& i < returnWmCo2LocationSumGridWeekOldTemp.size()) {

					temp2 = (HashMap<String, Object>) returnWmCo2LocationSumGridWeekOldTemp
							.get(i);
				}
				...
				if (isSearch) {
					...
					setTemp.put("WMSUM", temp.get("WM_TOTAL"));
					setTemp.put("CO2SUM", temp.get("CO2_TOTAL"));
					if (!temp2.isEmpty()) {

						setTemp.put("OLDWMSUM", temp2.get("WM_TOTAL"));
    ...
    protected List<HashMap<String, Object>> tmHmMonitoringMinMaxWeek(Map<String, Object> condition) {
		...
		if (!returnTMLocationTemp.isEmpty()) {
			...
			for (int i = 0; i < returnTMLocationTemp.size(); i++) {
				...
				HashMap<String, Object> tempTm = (HashMap<String, Object>) returnTMLocationTemp.get(i);
				HashMap<String, Object> tempHum = new HashMap<String, Object>();
				if (!returnHUMLocationTemp.isEmpty()) {
					tempHum = (HashMap<String, Object>) returnHUMLocationTemp
							.get(i);
	...
	/**
	 * 월별 수도사용량/탄솝출량 기본정보 월 사용량 , 평균요금 , 최소사용량 , 최대사용량
	 * 
	 * @param condition
	 * @return
	 */
	@SuppressWarnings({ "unchecked", "unused" })
    private List<HashMap<String, Object>> wmCo2MonitoringSumMinMaxMonthInfo(
			Map<String, Object> condition) {
		 ...
		 *         Node가 있으면 무조건 Children Node의 검침 데이터를 조회)
		 */
		returnWmCo2LocationSumGridTemp = monthWMDao
				.getConsumptionWmCo2MonitoringLocationId(conditionMonthInfo);
		if (returnWmCo2LocationSumGridTemp.isEmpty()) {
			Set<Location> childrenLocationSet = locationDao.get(locationId)
					.getChildren();
			...
			if (childrenLocationSet != null && !childrenLocationSet.isEmpty()) {
				returnWmCo2LocationSumGridTemp = monthWMDao
						.getConsumptionWmCo2MonitoringParentId(conditionMonthInfo);
			}
		}
		/*************************/
	...
	/**
	 * 월별 빌딩 전체 수도사용량/탄솝출량 의 합
	 * 
	 * @param condition
	 * @return
	 */
	@SuppressWarnings({ "unchecked", "unused" })
    private List<HashMap<String, Object>> wmCo2MonitoringSumMinMaxMonth(Map<String, Object> condition) {
		...
		List<Object> returnWmCo2LocationSumGridTemp = new ArrayList<Object>();
		List<Object> returnWmCo2LocationSumGridOldTemp = new ArrayList<Object>();
		...
		if (!parent.isEmpty()) {
			returnWmCo2LocationSumGridTemp = monthWMDao
					.getConsumptionWmCo2MonitoringLocationId(conditionYear);
			returnWmCo2LocationSumGridOldTemp = monthWMDao
					.getConsumptionWmCo2MonitoringLocationId(conditionOldYear);
		}
		if (returnWmCo2LocationSumGridTemp.isEmpty()) {
			Set<Location> childrenLocationSet = locationDao.get(locationId)
					.getChildren();
			...
			if (childrenLocationSet != null && !childrenLocationSet.isEmpty()) {
				returnWmCo2LocationSumGridTemp = monthWMDao
						.getConsumptionWmCo2MonitoringParentId(conditionYear);
				returnWmCo2LocationSumGridOldTemp = monthWMDao
						.getConsumptionWmCo2MonitoringParentId(conditionOldYear);
			}
		}
		...
		if (!returnWmCo2LocationSumGridTemp.isEmpty()) {
			...
			for (int i = 0; i < returnWmCo2LocationSumGridOldTemp.size(); i++) {

				HashMap<String, Object> temp = (HashMap<String, Object>) returnWmCo2LocationSumGridOldTemp
						.get(i);
			...
			for (int k = 0; k < 12; k++) {
				if (!addMonth.containsKey(k + 1 + "")) {
					...
					if (setOldTemp != null) {
						setTemp.put("OLDWMSUM", setOldTemp.get("WMSUM"));
	...
	/**
	 * 분기별 수도사용량/탄솝출량 기본정보 분기 사용량 , 평균 요금 , 최소사용량 , 최대 사용량
	 * 
	 * @param condition
	 * @return
	 */
	@SuppressWarnings({ "unchecked", "unused" })
    private List<HashMap<String, Object>> wmCo2MonitoringSumMinMaxQuarterInfo(
			Map<String, Object> condition) {
		BemsStatisticUtil bemsUtil = new BemsStatisticUtil();
		List<HashMap<String, Object>> result = new ArrayList<HashMap<String, Object>>();
		 ...
		 */
		returnWmCo2LocationSumGridTemp = monthWMDao
				.getConsumptionWmCo2MonitoringLocationId(conditionQuarter);
		if (returnWmCo2LocationSumGridTemp.isEmpty()) {
			Set<Location> childrenLocationSet = locationDao.get(locationId)
					.getChildren();
			...
			if (childrenLocationSet != null && !childrenLocationSet.isEmpty()) {
				returnWmCo2LocationSumGridTemp = monthWMDao
						.getConsumptionWmCo2MonitoringParentId(conditionQuarter);
			}
		}
		/*************************/
		...
		if (!returnWmCo2LocationSumGridTemp.isEmpty()) {
			...
			for (int i = 0; i < returnWmCo2LocationSumGridTemp.size(); i++) {
				...
				if (0 == (m1 % 3)
						|| (i + 1) == returnWmCo2LocationSumGridTemp.size()) {
					...
					sumCharge = sumCharge + bemsUtil.getUsageCharge(chargeMap);
	...
	/**
	 * 분기별 빌딩 전체 수도사용량/탄솝출량 의 합
	 * 
	 * @param condition
	 * @return
	 */
	@SuppressWarnings({ "unchecked", "unused" })
    private List<HashMap<String, Object>> wmCo2MonitoringSumMinMaxQuarter(Map<String, Object> condition) {
		...
		if (!returnWmCo2LocationSumGridTemp.isEmpty()) {
			...
			for (int i = 0; i < returnWmCo2LocationSumGridOldTemp.size(); i++) {
				...
				if (0 == (m1 % 3)
						|| (i + 1) == returnWmCo2LocationSumGridOldTemp.size()) {

					q = m1 / 3;
					if ((0 != (m1 % 3))
							&& (i + 1) == returnWmCo2LocationSumGridOldTemp
									.size()) {
						q = m1 / 3 + 1;
					}
					...
					setTemp.put("yyyy", year);
					setTemp.put("MYDATE", q + "Q");
					setTemp.put("WMSUM", emTotalTemp1);
    ...
    protected List<HashMap<String, Object>> tmHmMonitoringMinMaxQuarter(Map<String, Object> condition) {
        ...
        returnTmLocationGridTemp = new ArrayList<Object>();
        returnHummLocationGridTemp = new ArrayList<Object>();
	...
	@Override
	public Map<String, Object> getBuildingLookUpWmByParam(
	    ...
	    return getBuildingLookUpWm(condition);
	}

	@Override
	public Map<String, Object> getBuildingLookUpMaxWmByParam(
			String searchDateType, String supplierId, Integer detailLocationId) {
		Map<String, Object> condition = new HashMap<String, Object>();
	    condition .put("searchDateType", searchDateType);
	    condition .put("supplierId", supplierId);
	    condition .put("detailLocationId", detailLocationId);
	    return getBuildingLookUpMaxWm(condition);
	}
