...
@WebService(name = "EnergyBalanceMonitoringService", targetNamespace = "http://aimir.com/services")
@SOAPBinding(style = Style.DOCUMENT, use = Use.LITERAL, parameterStyle = ParameterStyle.WRAPPED)
public interface EnergyBalanceMonitoringManager {
     ...
     */
    @WebMethod
    @WebResult(name = "EbsDtsList")
    public List<Map<String, Object>> getEbsDtsList(@WebParam(name = "conditionMap") Map<String, Object> conditionMap);
