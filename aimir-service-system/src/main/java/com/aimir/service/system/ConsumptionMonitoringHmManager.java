...
/**
 * ConsumptionMonitoringHmManager.java Description 
 *
 * 
 * Date          Version     Author 
 * 2012. 7. 03.   v1.0       김미선         
...
@WSDLDocumentation("Heat Energy Consumption Monitoring Service")
@WebService(name="ConsumptionMonitoringHmService", targetNamespace="http://aimir.com/services")
@SOAPBinding(style=Style.DOCUMENT, use=Use.LITERAL, parameterStyle=ParameterStyle.WRAPPED)
public interface ConsumptionMonitoringHmManager {
	...
	@WSDLDocumentationCollection(
			...
			@WebMethod
			@WebResult(name="BuildingLookUpHmMap")
	...
	public Map<String, Object> getBuildingLookUpMaxHm(Map<String, Object> condition);
	...
	@WSDLDocumentationCollection(
			{
			        ...
			        @WSDLDocumentation(value = "Return Map \r\n"
									...
									+ " ($key=HMMIN, $valueType=Double, @description=Energy Consumption Min) \r\n"
									+ " ($key=HMMAX, $valueType=Double, @description=Energy Consumption Max) \r\n"
									+ " ($key=HMSUM, $valueType=Double, @description=Energy Consumption Summation) \r\n"
			...
			@WebMethod
			@WebResult(name="BuildingLookUpMaxHmMap")
