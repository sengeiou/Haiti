...
@WebService(endpointInterface = "com.aimir.service.system.ConsumptionMonitoringEmManager")
@Service(value = "consumptionMonitoringEmManager")
public class ConsumptionMonitoringEmManagerImpl implements
		ConsumptionMonitoringEmManager {

	Log logger = LogFactory.getLog(ConsumptionMonitoringEmManagerImpl.class);
    ...
    public Map<String, Object> getTotalUseOfSearchType(
		...
		try {
			...
			conditionDay.put("meterType", CommonConstants.MeterType.EnergyMeter
					.getMonthTableName());
			...
			conditionWeek.put("meterType",
					CommonConstants.MeterType.EnergyMeter.getMonthTableName());
			String weekday = "";
			...
			if (CommonConstants.DateType.DAILY.getCode().equals(searchDateType)) {
				...
				returnEnergyGrid = monthEMDao
						.getConsumptionEmCo2MonthSearchDayTypeTotal2(conditionDay);
				conditionDay.put("channel", DefaultChannel.Co2.getCode());
				returnCo2Grid = monthEMDao
						.getConsumptionEmCo2MonthSearchDayTypeTotal2(conditionDay);
				...
				if (!startWday.equals(endWday)) {
					returnEnergyGrid = monthEMDao
							.getConsumptionEmCo2MonthSearchDayTypeTotal2(conditionWeek);

					returnEnergyGrid2 = monthEMDao
							.getConsumptionEmCo2MonthSearchDayTypeTotal2(conditionWeek);
					conditionWeek.put("channel", DefaultChannel.Co2.getCode());

					returnCo2Grid = monthEMDao
							.getConsumptionEmCo2MonthSearchDayTypeTotal2(conditionWeek);
					returnCo2Grid2 = monthEMDao
							.getConsumptionEmCo2MonthSearchDayTypeTotal2(conditionWeek);
				...
				// 월
				returnEnergyGrid = monthEMDao
						.getConsumptionEmCo2MonthSearchDayTypeTotal2(conditionMonth);
				...
				// 분기
				returnEnergyGrid = monthEMDao
						.getConsumptionEmCo2MonthSearchDayTypeTotal2(conditionYear);
	...
	/*
	 * 빌딩(동/층) 전력 사용량 Max 페이지
	 */
	@SuppressWarnings({ "unchecked", "unused", "rawtypes" })
	public Map<String, Object> getBuildingLookUpMaxEm(
		...
		// 전력사용량/탄소배출량
		List<HashMap<String, Object>> returnEmCo2LocationDay = new ArrayList<HashMap<String, Object>>();
		List<HashMap<String, Object>> returnEmCo2LocationDayInfo = new ArrayList<HashMap<String, Object>>();
		List<HashMap<String, Object>> returnEmCo2LocationWeek = new ArrayList<HashMap<String, Object>>();
		List<HashMap<String, Object>> returnEmCo2LocationWeekInfo = new ArrayList<HashMap<String, Object>>();
		List<HashMap<String, Object>> returnEmCo2LocationMonth = new ArrayList<HashMap<String, Object>>();
		List<HashMap<String, Object>> returnEmCo2LocationMonthInfo = new ArrayList<HashMap<String, Object>>();
		List<HashMap<String, Object>> returnEmCo2LocationQuarter = new ArrayList<HashMap<String, Object>>();
		List<HashMap<String, Object>> returnEmCo2LocationQuarterInfo = new ArrayList<HashMap<String, Object>>();
		...
		try {
			...
			conditionDayLocation.put("meterType",
					CommonConstants.MeterType.EnergyMeter.getDayTableName());
			...
			returnEnergyGrid = dayEmDao
					.getConsumptionEmCo2DayMonitoringParentId(conditionDayLocation);
			conditionDayLocation.put("channel", DefaultChannel.Co2.getCode());
			returnCo2Grid = dayEmDao
					.getConsumptionEmCo2DayMonitoringParentId(conditionDayLocation);

			// 2. 주기별 사용량 조회
			// 일(시간)
			returnEmCo2LocationDay = emCo2MonitoringSumMinMaxDay(conditionDay);
			returnEmCo2LocationDayInfo = emCo2MonitoringSumMinMaxDayInfo(conditionDay);
			// 주
			returnEmCo2LocationWeek = emCo2MonitoringSumMinMaxWeek(conditionWeek);
			returnEmCo2LocationWeekInfo = emCo2MonitoringSumMinMaxWeekInfo(conditionWeek);
			// 월
			returnEmCo2LocationMonth = emCo2MonitoringSumMinMaxMonth(conditionMonth);
			returnEmCo2LocationMonthInfo = emCo2MonitoringSumMinMaxMonthInfo(conditionMonth);
			// 분기
			returnEmCo2LocationQuarter = emCo2MonitoringSumMinMaxQuarter(conditionYear);
			returnEmCo2LocationQuarterInfo = emCo2MonitoringSumMinMaxQuarterInfo(conditionYear);
		...
		result.put("myChartDataLocation", retGrid); // 동별 전력/탄소 값의 합.
		result.put("myChartDataDay", returnEmCo2LocationDay);
		result.put("myChartDataDayInfo", returnEmCo2LocationDayInfo);
		result.put("myChartDataWeek", returnEmCo2LocationWeek);
		result.put("myChartDataWeekInfo", returnEmCo2LocationWeekInfo);
		result.put("myChartDataMonth", returnEmCo2LocationMonth);
		result.put("myChartDataMonthInfo", returnEmCo2LocationMonthInfo);
		result.put("myChartDataQuarter", returnEmCo2LocationQuarter);
		result.put("myChartDataQuarterInfo", returnEmCo2LocationQuarterInfo);
		result.put("returnLocation", returnLocation); // 동정보

		return result;
	}
	/*
	 * 빌딩(동/층) 전력 사용량 Min 페이지
	 */
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public Map<String, Object> getBuildingLookUpEm(Map<String, Object> condition) {
		...
		// 전력사용량/탄소배출량
		List<HashMap<String, Object>> returnEmCo2LocationSumGrid = new ArrayList<HashMap<String, Object>>();
		...
		try {
			...
			if (CommonConstants.DateType.DAILY.getCode().equals(searchDateType)) {
				...
				returnEnergyGrid = dayEmDao
						.getConsumptionEmCo2DayMonitoringParentId(conditionDay);
				conditionDay.put("channel", DefaultChannel.Co2.getCode());
				returnCo2Grid = dayEmDao
						.getConsumptionEmCo2DayMonitoringParentId(conditionDay);
				...
				returnEnergyGrid = dayEmDao
						.getConsumptionEmCo2DayMonitoringParentId(conditionWeek);
				conditionWeek.put("channel", DefaultChannel.Co2.getCode());
				returnCo2Grid = dayEmDao
						.getConsumptionEmCo2DayMonitoringParentId(conditionWeek);
				...
				returnEnergyGrid = monthEMDao
						.getConsumptionEmCo2MonthMonitoringParentId(conditionMonth);
				conditionMonth.put("channel", DefaultChannel.Co2.getCode());
				returnCo2Grid = monthEMDao
						.getConsumptionEmCo2MonthMonitoringParentId(conditionMonth);
			} else if (CommonConstants.DateType.QUARTERLY.getCode().equals(
				...
				returnEnergyGrid = monthEMDao
						.getConsumptionEmCo2MonthMonitoringParentId(conditionYear);
				conditionYear.put("channel", DefaultChannel.Co2.getCode());
				returnCo2Grid = monthEMDao
						.getConsumptionEmCo2MonthMonitoringParentId(conditionYear);
			} else {
			...
			if (CommonConstants.DateType.DAILY.getCode().equals(searchDateType)) {
				...
				// 빌딩 전체 전력사용량/탄소 배출량 의 최대 ,최소,합
				returnEmCo2LocationSumGrid = emCo2MonitoringSumMinMaxDay(conditionDay);
				...
				// 빌딩 전체 전력사용량/탄솝출량 의 최대 ,최소,합
				returnEmCo2LocationSumGrid = emCo2MonitoringSumMinMaxWeek(conditionWeek);
				...
				// 빌딩 전체 전력사용량/탄솝출량 의 최대 ,최소,합
				returnEmCo2LocationSumGrid = emCo2MonitoringSumMinMaxMonth(conditionMonth);
				...
				// 빌딩 전체 전력사용량/탄솝출량 의 최대 ,최소,합
				returnEmCo2LocationSumGrid = emCo2MonitoringSumMinMaxQuarter(conditionYear);
		...
		List<Map<String, Object>> retGrid = new ArrayList<Map<String, Object>>();
		...
		result.put("grid", retGrid); // 동별 전력/탄소 값의 합.
		result.put("sumGrid", returnEmCo2LocationSumGrid); // 빌딩 전체 전력사용량/탄솝출량 의
		// 최대값 ,최소값,합
		result.put("sumTHGrid", returnTmHmLocationSumGrid); // 빌딩 전체 전력온도량/습도량 의
		// 합
		result.put("returnLocation", returnLocation); // 동정보
		return result;
	}
	...
	public int thisLocationLevel(int locationId) {
		...
		if (level1 == null || null == level1.getParent()) {
	...
	/**
	 * 일(시간) 빌딩 전체 : 전력사용량/탄솝출량 사용량 정보 금일 일사용량 , 평균요금 , 최소사용량 , 최대사용량
	 * 
	 * @param condition
	 * @return
	 */
	@SuppressWarnings({ "unused", "unchecked" })
    private List<HashMap<String, Object>> emCo2MonitoringSumMinMaxDayInfo(
			Map<String, Object> condition) {
		...
		List<Object> returnEmCo2LocationSumGridTemp = new ArrayList<Object>();
		 ...
		 */
		returnEmCo2LocationSumGridTemp = dayEmDao
				.getConsumptionEmCo2MonitoringSumMinMaxLocationId(conditionDayInfo);
		if (returnEmCo2LocationSumGridTemp.isEmpty()) {
//			Set<Location> childrenLocationSet = locationDao.get(locationId)
//					.getChildren();
			Location tmpLocation = locationDao.get(locationId);

			if (tmpLocation != null) {
			    Set<Location> childrenLocationSet = tmpLocation.getChildren();

			    if (childrenLocationSet != null && !childrenLocationSet.isEmpty()) {
	                returnEmCo2LocationSumGridTemp = dayEmDao
	                        .getConsumptionEmCo2MonitoringSumMinMaxPrentId(conditionDayInfo);
	            }
			}
		}
		/*************************/
		...
		if (!returnEmCo2LocationSumGridTemp.isEmpty()) {
			...
			for (int i = 0; i < returnEmCo2LocationSumGridTemp.size(); i++) {

			    HashMap<String, Object> temp = (HashMap<String, Object>) returnEmCo2LocationSumGridTemp.get(i);
				...
				for (int k = 0; k < 24; k++) {
					...
					try {
						...
						String val = (String)ObjectUtils.defaultIfNull(BeanUtils.getProperty(temp, "value_"+(k<10? "0":"")+k),"0");
						
						check = Double.parseDouble(val);
				...
				double totalValue = DecimalUtil.ConvertNumberToDouble(temp.get("EM_TOTAL"));
				setTemp.put("INFOTOTAL", formatter.format(totalValue) + " kWh");
	...
	/**
	 * 일(시간) 빌딩 전체 : 전력사용량/탄솝출량 의 최대 ,최소,합 금일 / 전일 데이터 조회
	 * 
	 * @param condition
	 * @return
	 */
	@SuppressWarnings({ "unused", "unchecked" })
    private List<HashMap<String, Object>> emCo2MonitoringSumMinMaxDay(Map<String, Object> condition) {
		...
		List<Object> returnEmCo2LocationSumGridTemp = new ArrayList<Object>();
		List<Object> returnEmCo2LocationSumGridTempOld = new ArrayList<Object>();
		...
		if (!parent.isEmpty()) {
			returnEmCo2LocationSumGridTemp = dayEmDao
					.getConsumptionEmCo2MonitoringSumMinMaxLocationId_bck(conditionDay);
			returnEmCo2LocationSumGridTempOld = dayEmDao
					.getConsumptionEmCo2MonitoringSumMinMaxLocationId_bck(conditionOldDay);
		}
		if (returnEmCo2LocationSumGridTemp.isEmpty()) {
//			Set<Location> childrenLocationSet = locationDao.get(locationId)
//					.getChildren();
			...
			if (tmpLocation != null) {
			    ...
			    if (childrenLocationSet != null && !childrenLocationSet.isEmpty()) {
	                returnEmCo2LocationSumGridTemp = dayEmDao
	                        .getConsumptionEmCo2MonitoringSumMinMaxPrentId(conditionDay);
	                returnEmCo2LocationSumGridTempOld = dayEmDao
	                        .getConsumptionEmCo2MonitoringSumMinMaxPrentId(conditionOldDay);
	            }
			}
		}
		/*************************/
		...
		if (!returnEmCo2LocationSumGridTemp.isEmpty()) {
			for (int i = 0; i < returnEmCo2LocationSumGridTemp.size(); i++) {
				HashMap<String, Object> temp = (HashMap<String, Object>) returnEmCo2LocationSumGridTemp
						.get(i);
				HashMap<String, Object> temp2 = new HashMap<String, Object>();
				if (!returnEmCo2LocationSumGridTempOld.isEmpty()) {

					temp2 = (HashMap<String, Object>) returnEmCo2LocationSumGridTempOld
							.get(i);
				}
				for (int k = 0; k < 24; k++) {
					String setTime = StringUtils.leftPad(String.valueOf(k), 2,
					...
					setTemp.put("EMMIN", temp.get("EM_MIN_" + setTime));
					setTemp.put("EMMAX", temp.get("EM_MAX_" + setTime));
					setTemp.put("EMSUM", temp.get("EM_SUM_" + setTime));
					...
					if (!temp2.isEmpty()) {
						...
						setTemp.put("OLDEMMIN", temp2.get("EM_MIN_" + setTime));
						setTemp.put("OLDEMMAX", temp2.get("EM_MAX_" + setTime));
						setTemp.put("OLDEMSUM", temp2.get("EM_SUM_" + setTime));
						...
						setTemp.put("OLDEMMIN", null);
						setTemp.put("OLDEMMAX", null);
						setTemp.put("OLDEMSUM", null);
		    ...
		    for (int k = 0; k < 24; k++) {
                ...
                setTemp.put("OLDEMMIN", 0);
                setTemp.put("OLDEMMAX", 0);
                setTemp.put("OLDEMSUM", 0);
		...
		if (!returnTMLocationTemp.isEmpty()) {
			...
			for (int i = 0; i < returnTMLocationTemp.size(); i++) {
				...
				for (int k = 0; k < 24; k++) {
					...
					setTemp.put("HUM_MAX", tempTm.get("HUM_MAXVALUE"));
					setTemp.put("HUM_MIN", tempTm.get("HUM_MINVALUE"));
            ...
            for (int k = 0; k < 24; k++) {
                ...
                setTemp.put("HUM_MAX", 0);
                setTemp.put("HUM_MIN", 0);
                setTemp.put("HUM", 0);
	...
	/**
	 * 일주일 : 빌딩 전체 전력사용량/탄솝출량 의 합 기본정보 금주 주간 사용량 합 , 평균사용요금 , 최소사용량 , 최대사용량.
	 * 
	 * @param condition
	 * @return
	 */
	@SuppressWarnings("unchecked")
    private List<HashMap<String, Object>> emCo2MonitoringSumMinMaxWeekInfo(
			Map<String, Object> condition) {
		 ...
		 */
		returnEmCo2LocationSumGridTemp = dayEmDao
				.getConsumptionEmCo2WeekMonitoringLocationId(conditionWeek);
		if (returnEmCo2LocationSumGridTemp.isEmpty()) {
//			Set<Location> childrenLocationSet = locationDao.get(locationId)
//					.getChildren();
			Location tmpLocation = locationDao.get(locationId);
			...
			if (tmpLocation != null) {
                ...
                if (childrenLocationSet != null && !childrenLocationSet.isEmpty()) {
                    returnEmCo2LocationSumGridTemp = dayEmDao.getConsumptionEmCo2WeekMonitoringParentId(conditionWeek);
                }
			}
		}
		/*************************/
		...
		if (!returnEmCo2LocationSumGridTemp.isEmpty()) {
			...
			for (int i = 0; i < 7; i++) {
				...
				for (int j = 0; j < returnEmCo2LocationSumGridTemp.size(); j++) {
					temp = (HashMap<String, Object>) returnEmCo2LocationSumGridTemp
							.get(j);
				...
				chargeMap.put("serviceType",
						MeterType.EnergyMeter.getServiceType());
				chargeMap.put("dateType", DateType.DAILY.getCode());
				chargeMap.put("usage", check);
				...
				avgCharge = sumCharge / returnEmCo2LocationSumGridTemp.size();
	...
	/**
	 * 일주일 : 빌딩 전체 전력사용량/탄솝출량 의 합 금주 / 전주 데이터 조회
	 * 
	 * @param condition
	 * @return
	 */
	@SuppressWarnings("unchecked")
    private List<HashMap<String, Object>> emCo2MonitoringSumMinMaxWeek(Map<String, Object> condition) {
		...
		List<Object> returnEmCo2LocationSumGridWeekTemp = new ArrayList<Object>();
		List<Object> returnEmCo2LocationSumGridWeekOldTemp = new ArrayList<Object>();
		...
		if (!parent.isEmpty()) {
			returnEmCo2LocationSumGridWeekTemp = dayEmDao
					.getConsumptionEmCo2WeekMonitoringLocationId(conditionWeek);
			returnEmCo2LocationSumGridWeekOldTemp = dayEmDao
					.getConsumptionEmCo2WeekMonitoringLocationId(conditionOldWeek);
		}
		if (returnEmCo2LocationSumGridWeekTemp.isEmpty()) {
//			Set<Location> childrenLocationSet = locationDao.get(locationId)
//					.getChildren();
			Location tmpLocation = locationDao.get(locationId);
			...
			if (tmpLocation != null) {
			    Set<Location> childrenLocationSet = tmpLocation.getChildren();
		         ...
		         if (childrenLocationSet != null && !childrenLocationSet.isEmpty()) {
		                returnEmCo2LocationSumGridWeekTemp = dayEmDao
		                        .getConsumptionEmCo2WeekMonitoringParentId(conditionWeek);
		                returnEmCo2LocationSumGridWeekOldTemp = dayEmDao
		                        .getConsumptionEmCo2WeekMonitoringParentId(conditionOldWeek);
		            }
			}
		}
		/*************************/
		...
		if (!returnEmCo2LocationSumGridWeekTemp.isEmpty()) {
            ...
            for (int i = 0; i < 7; i++) {
				...
				for (int j = 0; j < returnEmCo2LocationSumGridWeekTemp.size(); j++) {
					temp = (HashMap<String, Object>) returnEmCo2LocationSumGridWeekTemp
							.get(j);
				...
				temp = (HashMap<String, Object>) returnEmCo2LocationSumGridWeekTemp
						.get(k);
				if (!returnEmCo2LocationSumGridWeekOldTemp.isEmpty()
						&& i < returnEmCo2LocationSumGridWeekOldTemp.size()) {

					temp2 = (HashMap<String, Object>) returnEmCo2LocationSumGridWeekOldTemp
							.get(i);
				}
				...
				if (isSearch) {
					...
					setTemp.put("EMSUM", temp.get("EM_TOTAL"));
					setTemp.put("CO2SUM", temp.get("CO2_TOTAL"));
					if (!temp2.isEmpty()) {

						setTemp.put("OLDEMSUM", temp2.get("EM_TOTAL"));
	...
	/**
	 * 월별 전력사용량/탄솝출량 기본정보 월 사용량 , 평균요금 , 최소사용량 , 최대사용량
	 * 
	 * @param condition
	 * @return
	 */
	@SuppressWarnings({ "unchecked", "unused" })
    private List<HashMap<String, Object>> emCo2MonitoringSumMinMaxMonthInfo(
			Map<String, Object> condition) {
		 ...
		 *         Node가 있으면 무조건 Children Node의 검침 데이터를 조회)
		 */
		returnEmCo2LocationSumGridTemp = monthEMDao
				.getConsumptionEmCo2MonitoringLocationId(conditionMonthInfo);
		if (returnEmCo2LocationSumGridTemp.isEmpty()) {
//			Set<Location> childrenLocationSet = locationDao.get(locationId)
//					.getChildren();
			Location tmpLocation = locationDao.get(locationId);
			...
			if (tmpLocation != null) {
	            ...
	            if (childrenLocationSet != null && !childrenLocationSet.isEmpty()) {
	                returnEmCo2LocationSumGridTemp = monthEMDao
	                        .getConsumptionEmCo2MonitoringParentId(conditionMonthInfo);
	            }
			}
		}
		/*************************/
	...
	/**
	 * 월별 빌딩 전체 전력사용량/탄솝출량 의 합
	 * 
	 * @param condition
	 * @return
	 */
	@SuppressWarnings({ "unchecked", "unused" })
    private List<HashMap<String, Object>> emCo2MonitoringSumMinMaxMonth(Map<String, Object> condition) {
		...
		List<Object> returnEmCo2LocationSumGridTemp = new ArrayList<Object>();
		List<Object> returnEmCo2LocationSumGridOldTemp = new ArrayList<Object>();
		...
		if (!parent.isEmpty()) {
			returnEmCo2LocationSumGridTemp = monthEMDao
					.getConsumptionEmCo2MonitoringLocationId(conditionYear);
			returnEmCo2LocationSumGridOldTemp = monthEMDao
					.getConsumptionEmCo2MonitoringLocationId(conditionOldYear);
		}
...
//					.getChildren();
			...
			if (tmpLocation != null) {
	            ...
	            if (childrenLocationSet != null && !childrenLocationSet.isEmpty()) {
	                returnEmCo2LocationSumGridTemp = monthEMDao
	                        .getConsumptionEmCo2MonitoringParentId(conditionYear);
	                returnEmCo2LocationSumGridOldTemp = monthEMDao
	                        .getConsumptionEmCo2MonitoringParentId(conditionOldYear);
	            }
			}
		}
		...
		if (!returnEmCo2LocationSumGridTemp.isEmpty()) {
			...
			for (int i = 0; i < returnEmCo2LocationSumGridTemp.size(); i++) {
				...
				HashMap<String, Object> temp = (HashMap<String, Object>) returnEmCo2LocationSumGridTemp
						.get(i);
				// HashMap<String, Object> temp2 = new HashMap<String,
				// Object>();
				// if (!returnEmCo2LocationSumGridOldTemp.isEmpty()
				// && i < returnEmCo2LocationSumGridOldTemp.size()) {
				//
				// temp2 = (HashMap<String, Object>)
				// returnEmCo2LocationSumGridOldTemp
				// .get(i);
				// }
				String setDate = temp.get("YYYYMM").toString();
			...
			for (int i = 0; i < returnEmCo2LocationSumGridOldTemp.size(); i++) {

				HashMap<String, Object> temp = (HashMap<String, Object>) returnEmCo2LocationSumGridOldTemp
						.get(i);
			...
			for (int k = 0; k < 12; k++) {
				if (!addMonth.containsKey(k + 1 + "")) {
					...
					HashMap<String, Object> setOldTemp = (HashMap<String, Object>) addOldMonth
							.get(k + 1 + "");
					if (setOldTemp != null) {
						setTemp.put("OLDEMSUM", setOldTemp.get("EMSUM"));
            ...
            for (int k = 0; k < 12; k++) {
                setTemp = new HashMap<String, Object>();
                setTemp.put("yyyymm", startDate.substring(0, 6));
                setTemp.put("MYDATE", k + 1);
                setTemp.put("EMSUM", 0);
                setTemp.put("CO2SUM", 0);
                setTemp.put("OLDEMSUM", 0);
...
//			Double tmMin = 20d;
			...
			for (int i = 0; i < returnTmLocationSumGridTemp.size(); i++) {
				...
				HashMap<String, Object> tempTm = (HashMap<String, Object>) returnTmLocationSumGridTemp
						.get(i);
				HashMap<String, Object> tempHum = new HashMap<String, Object>();
				if (!returnHumLocationSumGridTemp.isEmpty()) {

					tempHum = (HashMap<String, Object>) returnHumLocationSumGridTemp
							.get(i);
				}
	...
	/**
	 * 분기별 전력사용량/탄솝출량 기본정보 분기 사용량 , 평균 요금 , 최소사용량 , 최대 사용량
	 * 
	 * @param condition
	 * @return
	 */
	@SuppressWarnings({ "unchecked", "unused" })
    private List<HashMap<String, Object>> emCo2MonitoringSumMinMaxQuarterInfo(
			Map<String, Object> condition) {
		 ...
		 */
		returnEmCo2LocationSumGridTemp = monthEMDao
				.getConsumptionEmCo2MonitoringLocationId(conditionQuarter);
		if (returnEmCo2LocationSumGridTemp.isEmpty()) {
//			Set<Location> childrenLocationSet = locationDao.get(locationId)
//					.getChildren();
			Location tmpLocation = locationDao.get(locationId);
			...
			if (tmpLocation != null) {
	            ...
	            if (childrenLocationSet != null && !childrenLocationSet.isEmpty()) {
	                returnEmCo2LocationSumGridTemp = monthEMDao
	                        .getConsumptionEmCo2MonitoringParentId(conditionQuarter);
	            }
			}
		}
		/*************************/
		...
		if (!returnEmCo2LocationSumGridTemp.isEmpty()) {
			...
			for (int i = 0; i < returnEmCo2LocationSumGridTemp.size(); i++) {
				...
				if (0 == (m1 % 3)
						|| (i + 1) == returnEmCo2LocationSumGridTemp.size()) {
	...
	/**
	 * 분기별 빌딩 전체 전력사용량/탄솝출량 의 합
	 * 
	 * @param condition
	 * @return
	 */
	@SuppressWarnings({ "unchecked", "unused" })
    private List<HashMap<String, Object>> emCo2MonitoringSumMinMaxQuarter(Map<String, Object> condition) {
...
//					.getChildren();
		...
		if (!returnEmCo2LocationSumGridTemp.isEmpty()) {
			...
			for (int i = 0; i < returnEmCo2LocationSumGridOldTemp.size(); i++) {
				...
				if (0 == (m1 % 3)
						|| (i + 1) == returnEmCo2LocationSumGridOldTemp.size()) {

					q = m1 / 3;
					if ((0 != (m1 % 3))
							&& (i + 1) == returnEmCo2LocationSumGridOldTemp
									.size()) {
						q = m1 / 3 + 1;
					}
					...
					setTemp.put("yyyy", year);
					setTemp.put("MYDATE", q + "Q");
					setTemp.put("EMSUM", emTotalTemp1);
	...
	@Override
	public Map<String, Object> getBuildingLookUpEmByParam(
	    ...
	    return getBuildingLookUpEm(condition);
	}

	@Override
	public Map<String, Object> getBuildingLookUpMaxEmByParam(
			String searchDateType, String supplierId, Integer detailLocationId) {
		Map<String, Object> condition = new HashMap<String, Object>();
	    condition .put("searchDateType", searchDateType);
	    condition .put("supplierId", supplierId);
	    condition .put("detailLocationId", detailLocationId);
	    return getBuildingLookUpMaxEm(condition);
	}
