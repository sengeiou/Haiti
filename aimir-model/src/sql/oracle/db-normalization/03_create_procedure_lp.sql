CREATE OR REPLACE PROCEDURE AIMIR.LP_EXTERNAL_MERGE(THREAD_NUM IN NUMBER, P_RESULT OUT VARCHAR2) IS         
...
STMT := 'MERGE INTO AIMIR.LP_EM LP_TOBE USING AIMIR.LP_EM_EXT_'||THREAD_NUM||' LP_TOBE_EXT ';   
