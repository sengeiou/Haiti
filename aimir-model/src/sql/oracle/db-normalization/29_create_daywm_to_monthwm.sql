...
--DROP TABLE AIMIR.DAYWM_TO_MONTHWM;
CREATE TABLE AIMIR.DAYWM_TO_MONTHWM
(
...
CREATE INDEX AIMIR.IDX_DAYWM_TO_MONTHWM ON AIMIR.DAYWM_TO_MONTHWM(MDEV_ID, YYYYMMDD, CHANNEL, MDEV_TYPE, DST, HH)
TABLESPACE "AIMIRIDX" ;
