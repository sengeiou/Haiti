CREATE OR REPLACE PROCEDURE AIMIR.BATCH_DAY_EM IS        
...
INSERT INTO AIMIR.DUMMY_LPEM_TO_DAYEM SELECT /*+ INDEX(LPEM_TO_DAYEM IDX_LPEM_TO_DAYEM) */ MDEV_ID, YYYYMMDDHHMISS, CHANNEL, MDEV_TYPE, DST, WRITEDATE FROM AIMIR.LPEM_TO_DAYEM WHERE ROWNUM <= 100000;      
