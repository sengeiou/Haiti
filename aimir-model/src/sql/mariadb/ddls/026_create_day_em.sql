...
CREATE INDEX PK_DAY_EM ON AIMIR.DAY_EM (MDEV_ID, YYYYMMDD, CHANNEL, MDEV_TYPE, DST, HH);
ALTER TABLE DAY_EM ADD CONSTRAINT PK_DAY_EM PRIMARY KEY (MDEV_ID, YYYYMMDD, CHANNEL, MDEV_TYPE, DST, HH);


ALTER TABLE DAY_EM  MODIFY CH_METHOD VARCHAR(10);

ALTER TABLE DAY_EM  MODIFY DST TINYINT NOT NULL;
