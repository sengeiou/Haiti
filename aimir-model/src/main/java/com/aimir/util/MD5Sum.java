...
public class MD5Sum
{
    ...
    /**
     * Method: md5Sum Purpose: calculate the MD5 in a way compatible with how the
     * scour.net protocol encodes its passwords (incidentally, it also outputs a string
     * identical to the md5sum unix command).
     *
     * @param str
