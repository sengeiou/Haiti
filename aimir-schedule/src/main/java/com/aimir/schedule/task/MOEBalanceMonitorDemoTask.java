 ...
 */
@Transactional
public class MOEBalanceMonitorDemoTask extends ScheduleTask {

    protected static Log log = LogFactory.getLog(MOEBalanceMonitorDemoTask.class);
    ...
    public static void main(String[] args) {
        ...
        MOEBalanceMonitorDemoTask task = ctx.getBean(MOEBalanceMonitorDemoTask.class);
        task.execute(null);
        System.exit(0);
    }
    ...
    public void execute(JobExecutionContext context) {
		if(isNowRunning){
			log.info("########### MOEBalanceMonitorDemoTask is already running...");
			return;
		}
		isNowRunning = true;
        log.info("############################# MOE Balance Demo Scheduler Start ##################################");
        ...
        try {
            ...
            List<Object> contracts = contractDao.getContractIdByContractNo("nuri_contract1");
            ...
            if (contracts == null || contracts.size() <= 0) {
                ...
                txStatus = null;
                isNowRunning = false;
                log.info("############################# MOE Balance Demo Scheduler End ##################################");
...
class MOEBalanceDemoThread implements Runnable {
    private static Log log = LogFactory.getLog(MOEBalanceDemoThread.class);
    ...
    MOEBalanceDemoThread(Protocol protocolType, String mcuId, List<Contract> contractList) {
