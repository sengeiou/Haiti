 ...
 */
@Service
public class ECGBlockDailyEMBillingInfoSaveV4Task extends ScheduleTask {
    
    protected static Log log = LogFactory.getLog(ECGBlockDailyEMBillingInfoSaveV4Task.class);
    ...
    public static void main(String[] args) {
        ...
        ECGBlockDailyEMBillingInfoSaveV4Task task = ctx.getBean(ECGBlockDailyEMBillingInfoSaveV4Task.class);
        task.execute(null);
        System.exit(0);
    }
    ...
    public List<Integer> getContractInfos(String serviceType){
        ...
        try {
            ...
            contractIds.add(33098);
            contractIds.add(31097);
            contractIds.add(24633);
            contractIds.add(10979);
            contractIds.add(37500);
            contractIds.add(31946);
            contractIds.add(41006);
            contractIds.add(44791);
            contractIds.add(13278);
            contractIds.add(13280);
            contractIds.add(16770);
            contractIds.add(16771);
            contractIds.add(16772);
            contractIds.add(16773);
            contractIds.add(16774);
            contractIds.add(17023);
            contractIds.add(17038);
            contractIds.add(17046);
            contractIds.add(17048);
            contractIds.add(17049);
            contractIds.add(17155);
            contractIds.add(17225);
            contractIds.add(17230);
            contractIds.add(17344);
            contractIds.add(17388);
            contractIds.add(18004);
            contractIds.add(18366);
            contractIds.add(18418);
            contractIds.add(18710);
            contractIds.add(12146);
            contractIds.add(13279);
        }
        catch (Exception e) {
            log.error(e, e);
     ...
     * @return
     */
    public LpEM[] getLastLp(String meterId, String yyyymmddhh, String meterInstallDate) {
        TransactionStatus txstatus = null;
        try {
            txstatus = txmanager.getTransaction(null);
            ...
            if (yyyymmddhh != null && !"".equals(yyyymmddhh))
                conditions.add(new Condition("id.yyyymmddhhmiss", new Object[]{yyyymmddhh + "0000"}, null, Restriction.LE));
    ...
    public LpEM[] getFirstLp(String meterId, String contractNumber, String contractDate) {
        ...
        conditions.add(new Condition("id.channel", new Object[]{KamstrupChannel.ActiveEnergyImp.getChannel()},
                null, Restriction.EQ));
        conditions.add(new Condition("id.dst", new Object[]{0}, null, Restriction.EQ));
        conditions.add(new Condition("id.yyyymmddhhmiss", new Object[]{contractDate.substring(0, 10) + "0000"}, null, Restriction.GE));
        ...
        String yyyymmddhhmiss_contract = (String)minyyyymmddhh.get(0).get("minYyyymmddhhmiss");
    ...
    public BillingBlockTariff getLastBillingBlockTariff(String meterId, LpEM[] lastLp) throws Exception {
        ...
        // 고객의 계약 기준으로 최초값을 가져온다.
            ...
            if (contractDate != null && !"".equals(contractDate)) {
                ...
                LpEM[] lps = getLastLp(meterId, contractDate.substring(0, 10), meter.getInstallDate());
    ...
    throws Exception
    {
        ...
        if (meter.getModem() != null && meter.getModem().getModemType() == ModemType.ZRU) {
            ...
            savePrepyamentLog(contract, lastLpActiveEnergy - blockBillActiveEnergy,
                    monthBill-blockBillAccumulateBill, lastLpTime, lastTokenDate);
        }
        else {
            double monthBill = blockBill(tariffName, tariffEMList, usage);
    ...
    private void savePrepyamentLog(Contract contract, double usage, double bill, String lastLpTime, String lastTokenDate) {
