...
/**
 * <p>EndDeviceEventsRequestMessageType complex type에 대한 Java 클래스입니다.
 * 
 * <p>다음 스키마 단편이 이 클래스에 포함되는 필요한 콘텐츠를 지정합니다.
 * 
 * <pre>
 * &lt;complexType name="EndDeviceEventsRequestMessageType">
 *   &lt;complexContent>
...
@XmlType(name = "EndDeviceEventsRequestMessageType", propOrder = {
    "header",
    "request",
    "payload"
})
public class EndDeviceEventsRequestMessageType {
