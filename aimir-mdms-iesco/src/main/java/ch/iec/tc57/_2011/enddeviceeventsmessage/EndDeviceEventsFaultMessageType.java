...
/**
 * <p>EndDeviceEventsFaultMessageType complex type에 대한 Java 클래스입니다.
 * 
...
@XmlType(name = "EndDeviceEventsFaultMessageType", propOrder = {
    "reply"
})
public class EndDeviceEventsFaultMessageType {
