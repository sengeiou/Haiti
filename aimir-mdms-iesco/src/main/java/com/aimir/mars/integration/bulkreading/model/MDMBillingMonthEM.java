...
@Entity
@Table(name="MDM_BILLING_MONTH_EM")
@IdClass(MDMBillingMonthEMPK.class)
public class MDMBillingMonthEM extends BaseObject implements JSONString {
	...
	@Id
	@Column(name="MDEV_TYPE",length=10)
	...
	@Column(name="ACTIVEPWRDMDMAXTIMERATETOT",length=14)
	@ColumnInfo(name="ACTIVEPWRDMDMAXTIMERATETOT")	
	private String activePowerDemandMaxTimeRateTotal;
	
	@Column(name="ACTIVEPWRMAXDMDRATETOT")
	@ColumnInfo(name="ACTIVEPWRMAXDMDRATETOT")	
	...
	public void setActivePowerDemandMaxTimeRateTotal(String activePowerDemandMaxTimeRateTotal) {
	...
	public void setActivePowerMaxDemandRateTotal(Double activePowerMaxDemandRateTotal) {
