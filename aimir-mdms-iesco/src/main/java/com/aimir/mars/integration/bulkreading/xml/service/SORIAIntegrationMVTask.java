 ...
 * </p>
 * 
 * SORIAIntegrationMVTask.java
 *
 */
public class SORIAIntegrationMVTask {

    private static Log log = LogFactory.getLog(SORIAIntegrationMVTask.class);
    ...
    public int start(String configFile) {
        ...
        try {
            ...
            JobLauncher jobLauncher = (JobLauncher) context
                    .getBean("jobLauncher");
            Job job = (Job) context.getBean("soriaIntegrationMVTask");
