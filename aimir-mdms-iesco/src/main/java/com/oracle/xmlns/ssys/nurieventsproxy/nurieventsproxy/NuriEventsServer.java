...
public class NuriEventsServer implements NuriEvents {

    private static Log log = LogFactory.getLog(NuriEventsServer.class);
    ...
    public XMLGregorianCalendar nuriEventsBulk(EndDeviceEventsEventMessageType part1) {
        log.debug(part1);
