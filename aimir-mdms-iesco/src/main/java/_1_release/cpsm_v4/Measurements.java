 ...
 *       &lt;sequence>
 *         &lt;element name="measurementID" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Measurements {
	...
	@XmlElement
    protected List<String> measurementID;
    ...
    public List<String> getMeasurementID() {
        if (measurementID == null) {
            measurementID = new ArrayList<String>();
        }
