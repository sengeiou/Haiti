...
public class BlockStatus {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "overflow", namespace = "http://www.multispeak.org/Version_4.1_Release", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "longInterval", namespace = "http://www.multispeak.org/Version_4.1_Release", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "partialInterval", namespace = "http://www.multispeak.org/Version_4.1_Release", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "manuallyEntered", namespace = "http://www.multispeak.org/Version_4.1_Release", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "recorderStopped", namespace = "http://www.multispeak.org/Version_4.1_Release", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "invalid", namespace = "http://www.multispeak.org/Version_4.1_Release", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "clockBackward", namespace = "http://www.multispeak.org/Version_4.1_Release", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "manuallyModified", namespace = "http://www.multispeak.org/Version_4.1_Release", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "configChanged", namespace = "http://www.multispeak.org/Version_4.1_Release", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "clockForward", namespace = "http://www.multispeak.org/Version_4.1_Release", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "DSTinEffect", namespace = "http://www.multispeak.org/Version_4.1_Release", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "testData", namespace = "http://www.multispeak.org/Version_4.1_Release", type = JAXBElement.class, required = false)
    })
