 ...
 *         &lt;element name="crewsAssigned" type="{http://www.multispeak.org/Version_4.1_Release}crewsDispatched" minOccurs="0"/>
...
@XmlRootElement(name = "AssignCrewsToOutage")
public class AssignCrewsToOutage {

    protected String outageEventID;
    protected CrewsDispatched crewsAssigned;
    ...
    /**
     * Gets the value of the crewsAssigned property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public CrewsDispatched getCrewsAssigned() {
        return crewsAssigned;
    }

    /**
     * Sets the value of the crewsAssigned property.
     * 
     * @param value
     *     allowed object is
     *     {@link CrewsDispatched }
     *     
     */
    public void setCrewsAssigned(CrewsDispatched value) {
        this.crewsAssigned = value;
    }
