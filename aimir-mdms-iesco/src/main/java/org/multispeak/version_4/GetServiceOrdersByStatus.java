 ...
 *       &lt;sequence>
 *         &lt;element name="status" type="{http://www.multispeak.org/Version_4.1_Release}soStatusCode"/>
...
@XmlRootElement(name = "GetServiceOrdersByStatus")
public class GetServiceOrdersByStatus {

    @XmlElement(required = true)
    protected SoStatusCode status;
     ...
     *     
     */
    public void setStatus(SoStatusCode value) {
        this.status = value;
    }
