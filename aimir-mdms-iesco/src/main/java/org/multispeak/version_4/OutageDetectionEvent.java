    ...
    extends MspObject
{
    ...
    public String toString() {
        return "OutageDetectionEvent [phaseCode=" + phaseCode + ", eventTime="
                + eventTime + ", outageEventType=" + outageEventType
                + ", outageDetectionDeviceID=" + outageDetectionDeviceID
                + ", outageDetectionDeviceType=" + outageDetectionDeviceType
                + ", outageLocation=" + outageLocation + ", messageList="
                + messageList + ", outageCustomer=" + outageCustomer
                + ", priority=" + priority + ", percentConfident="
                + percentConfident + ", problemCode=" + problemCode
                + ", resolvedLevel=" + resolvedLevel + ", toString()="
                + super.toString() + "]";
    }
}
