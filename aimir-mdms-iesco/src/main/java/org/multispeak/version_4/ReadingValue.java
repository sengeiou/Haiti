...
public class ReadingValue {
	...
	@XmlElement(name="readingStatusCode")
    protected ReadingStatusCode readingStatusCode;
	@XmlElement(name="readingTypeCode")
    ...
    public String toString() {
        return "ReadingValue [extensions=" + extensions + ", extensionsList="
                + extensionsList + ", units=" + units + ", value=" + value
                + ", ratePeriod=" + ratePeriod + ", readingType=" + readingType
                + ", fieldName=" + fieldName + ", name=" + name
                + ", measurementPeriod=" + measurementPeriod + ", timeStamp="
                + timeStamp + ", readingStatusCode=" + readingStatusCode
