...
public class TestKamstrup2 extends TestMetering {

    private static Log log = LogFactory.getLog(TestKamstrup2.class);
    ...
    public static void main(String[] args)
    {
    	...
    	TestKamstrup2 test = new TestKamstrup2();
    	//test.setMCUID("11010");
    ...
    public MDData makeFrame() throws ParseException{
        ...
        for(int i = 0; i < nodeCount; i++){
            ...
            //String eui = "000B1200750"+ValueGenerator.randomTextString(i, 5);
            ...
            //String meterid = Hex.decode(code)+"000000000000000000000000";
