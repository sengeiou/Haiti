...
public class TestSM110  extends TestMetering {

    private static Log log = LogFactory.getLog(TestSM110.class);
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
    		...
    		if(pool.isShutdown()){
            	...
            	log.info("Start["+start+"], End["+end+"]" + i);
    		}
